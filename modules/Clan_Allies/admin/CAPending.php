...
OpenTable();
$a = 0;
$result = $db->sql_query("SELECT * FROM `".$prefix."_clan_allies_sites` WHERE `site_status`='0' ORDER BY `site_name`");
...
if($numrows > 0) {
  ...
  while($site_row = $db->sql_fetchrow($result)) {
    ...
    echo "<tr><td width='25%' align='center' valign='top' rowspan='7'>";
    ...
    echo " <a href='".$admin_file.".php?op=CAApprove&amp;site_id=".$site_row['site_id']."'><img src='modules/$modname/images/approve.png' border='0' alt='"._APPROVE."' title='"._APPROVE."'></a>";
