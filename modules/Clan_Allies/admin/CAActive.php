...
if($numrows > 0) {
  ...
  while($site_row = $db->sql_fetchrow($result)) {
    ...
    echo " <a href='".$admin_file.".php?op=CADeactivate&amp;site_id=".$site_row['site_id']."'><img src='modules/$modname/images/deactivate.png' border='0' alt='"._DEACTIVATE."' title='"._DEACTIVATE."'></a>";
