...
/* List Downloads waiting for validation */
    ...
    $parentid2 = $row5['parentid'];
        ...
        echo "</select><input type=\"hidden\" name=\"submitter\" value=\"$submitter\" /><input type=\"hidden\" name=\"op\" value=\"DownloadsAddDownload\" /><input type=\"submit\" value=" . _ADD . " /> [ <a class=\"rn_csrf\" href=\"".$admin_file.".php?op=DownloadsDelNew&amp;lid=$lid\">" . _DELETE . "</a> ]</form><br /><hr noshade=\"noshade\" /><br />";
    }
    CloseTable();
    echo "<br />";
    } else {
...
/* Add a New Main Category */
    ...
    OpenTable();
    echo "<center>[ <a class=\"rn_csrf\" href=\"".$admin_file.".php?op=DownloadsCleanVotes\"><font class=\"content\">" . _CLEANDOWNLOADSDB . "</font></a> | "
    ."<a href=\"".$admin_file.".php?op=DownloadsListBrokenDownloads\"><font class=\"content\">" . _BROKENDOWNLOADSREP . " ($totalbrokendownloads)</font></a> | "
    ."<a href=\"".$admin_file.".php?op=DownloadsListModRequests\"><font class=\"content\">" . _DOWNLOADMODREQUEST . " ($totalmodrequests)</font></a> | "
    ."<a href=\"".$admin_file.".php?op=DownloadsDownloadCheck\"><font class=\"content\">" . _VALIDATEDOWNLOADS . "</font></a> ]</center>";
    CloseTable();
    echo "<br />";
    OpenTable();
    echo "<form method=\"post\" action=\"".$admin_file.".php\">"
    ."<font class=\"content\"><b>" . _ADDMAINCATEGORY . "</b></font><br /><br />"
...
// Add a New Download to Database
    ...
    OpenTable();
    echo "<form method=\"post\" action=\"".$admin_file.".php\">"
        ."<font class=\"content\"><b>" . _ADDNEWDOWNLOAD . "</b></font><br /><br />"
    ...
    echo "</select><br /><br /><br />"
        ...
        ."<center><input type=\"submit\" value=\"" . _ADDURL . "\" /></center><br />"
        ."</form>";
    CloseTable();
    echo "<br />";
    } else {
...
// Modify Downloads
    ...
    OpenTable();
    echo "<form method=\"post\" action=\"".$admin_file.".php\">"
    ."<font class=\"content\"><b>" . _MODDOWNLOAD . "</b></font><br /><br />"
...
function DownloadsModDownload($lid) {
    ...
    while($row = $db->sql_fetchrow($result)) {
        ...
        ."" . _PAGEURL . ": <input type=\"text\" name=\"url\" value=\"$url\" size=\"50\" maxlength=\"100\" />&nbsp;[ <a href=\"index.php?url=$url\" target=\"_blank\">" . _CHECK . "</a> ]<br />"
        ."" . _DESCRIPTION . ":<br /><textarea name=\"description\" cols=\"60\" rows=\"10\">$description</textarea><br />"
        ...
        ."" . _FILESIZE . ": <input type=\"text\" name=\"filesize\" size=\"12\" maxlength=\"11\" value=\"$filesize\" /><br />"
        ."" . _VERSION . ": <input type=\"text\" name=\"version\" size=\"11\" maxlength=\"10\" value=\"$version\" /><br />"
        ."" . _HOMEPAGE . ": <input type=\"text\" name=\"homepage\" size=\"50\" maxlength=\"200\" value=\"$homepage\" />&nbsp;[ <a href=\"index.php?url=$homepage\" target=\"_blank\">" . _VISIT . "</a> ]<br />"
    ...
    ."<input type=\"submit\" value=\"" . _MODIFY . "\" /> [ <a class=\"rn_csrf\" href=\"".$admin_file.".php?op=DownloadsDelDownload&amp;lid=$lid\">" . _DELETE . "</a> ]</form><br />";
    CloseTable();
    echo "<br />";
    ...
    /* if returns 'bad query' status 0 (add editorial) */
        if ($recordexist == 0) {
            ...
            ."" . _EDITORIALTITLE . ":<br /><input type=\"text\" name=\"editorialtitle\" value=\"\" size=\"50\" maxlength=\"100\" /><br />"
            ."" . _EDITORIALTEXT . ":<br /><textarea name=\"editorialtext\" cols=\"60\" rows=\"10\"></textarea><br />"
            ."</select><input type=\"hidden\" name=\"op\" value=\"DownloadsAddEditorial\" /><input type=\"submit\" value=\"Add\" /></form>";
        } else {
...
//        $timestamp = mktime(0, 0, 0, $date_array['1'], $date_array['2'], $date_array['0']);
               $formatted_date = getFormattedDate($editorialtimestamp);
            echo "<center><font class=\"content\"><b>Modify Editorial</b></font></center><br /><br />"
                ...
                ."" . _EDITORIALTEXT . ":<br /><textarea name=\"editorialtext\" cols=\"60\" rows=\"10\">$editorialtext</textarea><br />"
                    ."</select><input type=\"hidden\" name=\"op\" value=\"DownloadsModEditorial\" /><input type=\"submit\" value=\"" . _MODIFY . "\" /> [ <a class=\"rn_csrf\" href=\"".$admin_file.".php?op=DownloadsDelEditorial&amp;downloadid=$lid\">" . _DELETE . "</a> ]";
                }
        }
    CloseTable();
    echo "<br />";
    ...
    echo "<tr><td width=20 colspan=1><b>User  </b></td><td colspan=5><b>Comment  </b></td><td><center><b>Delete</b></center></td><br /></tr>";
...
//        echo '<br />'.var_dump($ratingtime).'<br />';
//        $ratingtime = strtotime($ratingtimestamp);
...
//        $timestamp = mktime(0, 0, 0, $ratingtime[1], $ratingtime[2], $ratingtime[0]);
             $formatted_date = getFormattedDate($ratingtimestamp);
            echo "<tr><td valign=top bgcolor=$colorswitch>$ratinguser</td><td valign=top colspan=5 bgcolor=$colorswitch>$ratingcomments</td><td bgcolor=$colorswitch><center><b><a class=\"rn_csrf\" href=".$admin_file.".php?op=DownloadsDelComment&lid=$lid&rid=$ratingdbid>X</a></b></center></td><br /></tr>";
        $x++;
    ...
    echo "<tr><td><b>User  </b></td><td><b>IP Address  </b></td><td><b>Rating  </b></td><td><b>User AVG Rating  </b></td><td><b>Total Ratings  </b></td><td><b>Date  </b></td></font></b><td><center><b>Delete</b></center></td><br /></tr>";
...
//            $rating2 = intval($row6['rating']);
    ...
    echo "<tr><td colspan=2><b>IP Address  </b></td><td colspan=3><b>Rating  </b></td><td><b>Date  </b></font></td><td><center><b>Delete</b></center></td><br /></tr>";
...
//        $timestamp = mktime(0, 0, 0, $date_array['1'], $date_array['2'], $date_array['0']);
               $formatted_date = getFormattedDate($ratingtimestamp);
        echo "<td colspan=2 bgcolor=$colorswitch>$ratinghostname</td><td colspan=3 bgcolor=$colorswitch>$rating</td><td bgcolor=$colorswitch>$formatted_date  </font></b></td><td bgcolor=$colorswitch><center><b><a class=\"rn_csrf\" href=".$admin_file.".php?op=DownloadsDelVote&lid=$lid&rid=$ratingdbid>X</a></b></center></td></tr><br />";
        $x++;
        if ($colorswitch==$bgcolor1) $colorswitch=$bgcolor2;
        else $colorswitch=$bgcolor1;
        }
    ...
    echo "<tr><td colspan=2><b>IP Address  </b></td><td colspan=3><b>Rating  </b></td><td><b>Date  </b></td></font></b><td><center><b>Delete</b></center></td><br /></tr>";
...
//            $timestamp = mktime(0, 0, 0, $date_array['1'], $date_array['2'], $date_array['0']);
               $formatted_date = getFormattedDate($ratingtimestamp);
        echo "<tr><td colspan=2 bgcolor=$colorswitch>$ratinghostname</td><td colspan=3 bgcolor=$colorswitch>$rating</td><td bgcolor=$colorswitch>$formatted_date  </font></b></td><td bgcolor=$colorswitch><center><b><a class=\"rn_csrf\" href=".$admin_file.".php?op=DownloadsDelVote&lid=$lid&rid=$ratingdbid>X</a></b></center></td></tr><br />";
        $x++;
        if ($colorswitch==$bgcolor1) $colorswitch=$bgcolor2;
            else $colorswitch=$bgcolor1;
        }
...
function DownloadsListBrokenDownloads() {
    ...
    if ($totalbrokendownloads==0) {
            echo "<tr><td><center><font class=\"content\">" . _DNOREPORTEDBROKEN . "</font></center><br /><br /><br /></td></tr>";
    } else {
    ...
    $row2 = $db->sql_fetchrow($result2);
        ...
        echo "<td bgcolor=\"$colorswitch\"><a href=\"mailto:$owneremail\">$owner</a>";
            ...
            echo "</td>"
            ."<td bgcolor=\"$colorswitch\"><center><a class=\"rn_csrf\" href=\"".$admin_file.".php?op=DownloadsIgnoreBrokenDownloads&amp;lid=$lid\">X</a></center>"
            ."</td>"
            ."<td bgcolor=\"$colorswitch\"><center><a class=\"rn_csrf\" href=\"".$admin_file.".php?op=DownloadsDelBrokenDownloads&amp;lid=$lid\">X</a></center>"
            ."</td>"
...
function DownloadsListModRequests() {
    ...
    $row8 = $db->sql_fetchrow($result8);
        ...
        echo "<td align=\"right\"><font class=\"tiny\">( <a class=\"rn_csrf\" href=\"".$admin_file.".php?op=DownloadsChangeModRequests&amp;requestid=$requestid\">" . _ACCEPT . "</a> / <a class=\"rn_csrf\" href=\"".$admin_file.".php?op=DownloadsChangeIgnoreRequests&amp;requestid=$requestid\">" . _IGNORE . "</a> )</font></td></tr></table><br /><br />";
    }
...
function DownloadsDelCat($cid, $sid, $sub, $ok=0) {
    ...
    if($ok==1) {
        ...
        $nblink = 0;
        $nbsubcat = 0;
        $result = $db->sql_query('SELECT lid from ' . $prefix . '_downloads_downloads where cid=\''.$cid.'\'');
        $nblink = $db->sql_numrows($result);
        $result3 = $db->sql_query('SELECT cid from ' . $prefix . '_downloads_categories where parentid=\''.$cid.'\'');
        $nbsubcat = $db->sql_numrows($result3);
        while ($row3 = $db->sql_fetchrow($result3)) {
            $cid2 = intval($row3['cid']);
            $result4 = $db->sql_query('SELECT lid from ' . $prefix . '_downloads_downloads where cid=\''.$cid2.'\'');
        ...
        echo '<b>' . _EZTHEREIS . ' '.$nblink.' ' . _DOWNLOAD . ' ' . _EZATTACHEDTOCAT . '</b><br />';
        echo '<b>' . _DELEZDOWNLOADSCATWARNING . '</b><br /><br />';
    }
    echo '[ <a class="rn_csrf" href="'.$admin_file.'.php?op=DownloadsDelCat&amp;cid='.$cid.'&amp;sid='.$sid.'&amp;sub='.$sub.
...
function DownloadsAddCat($title, $cdescription) {
    ...
    echo "<br /><center><font class=\"content\">"
        ."<b>" . _ERRORTHECATEGORY . " $title " . _ALREADYEXIST . "</b></font></center><br /><br />"
        ."" . _GOBACK . "<br /><br />";
    CloseTable();
    include_once('footer.php');
    } else {
...
function DownloadsAddSubCat($cid, $title, $cdescription) {
    ...
    echo "<font class=\"content\">"
        ."<b>" . _ERRORTHESUBCATEGORY . " $title " . _ALREADYEXIST . "</b></font></center><br /><br />"
        ."" . _GOBACK . "<br /><br />";
    include_once('footer.php');
    } else {
...
function DownloadsAddEditorial($downloadid, $editorialtitle, $editorialtext) {
    ...
    echo "<center><br />"
    ."<font class=option>"
    ."" . _EDITORIALADDED . "</font></center><br /><br />"
    ."[ <a href=\"".$admin_file.".php?op=downloads\"><center><font class=\"option\">" . _WEBDOWNLOADSADMIN . "</font></center></a> ]<br /><br />";
...
function DownloadsModEditorial($downloadid, $editorialtitle, $editorialtext) {
    ...
    echo "<br /><center>"
    ."<font class=\"content\">"
    ."" . _EDITORIALMODIFIED . "</font></center><br /><br />"
    ."[ <a href=\"".$admin_file.".php?op=downloads\"><center><font class=\"content\">" . _WEBDOWNLOADSADMIN . "</font></center></a> ]<br /><br />";
    CloseTable();
    include_once('footer.php');
}
...
function DownloadsDelEditorial($downloadid) {
    ...
    echo "<br /><center>"
    ."<font class=\"content\">"
    ."" . _EDITORIALREMOVED . "</font></center><br /><br />"
    ."[ <a href=\"".$admin_file.".php?op=downloads\"><center><font class=\"content\">" . _WEBDOWNLOADSADMIN . "</font></center></a> ]<br /><br />";
    CloseTable();
    include_once('footer.php');
}
...
function DownloadsValidate($cid, $sid, $ttitle) {
    ...
    $fp = fsockopen($vurl['host'], 80, $errno, $errstr, 15);
        ...
        ."<td align=\"center\"><font class=\"content\">&nbsp;&nbsp;[ <a href=\"".$admin_file.".php?op=DownloadsModDownload&amp;lid=$lid\">" . _EDIT . "</a> | <a class=\"rn_csrf\" href=\"".$admin_file.".php?op=DownloadsDelDownload&amp;lid=$lid\">" . _DELETE . "</a> ]&nbsp;&nbsp;</font>"
        ."</td></tr>";
        }
        if ($fp){
...
// Check if Description exist
    ...
    echo "[ <a href=\"".$admin_file.".php?op=downloads\">" . _WEBDOWNLOADSADMIN . "</a> ]</font></center><br /><br />";
    CloseTable();
    if ($new==1) {
    $db->sql_query("delete from " . $prefix . "_downloads_newdownload where lid='$lid'");
    }
