...
define('_CLEANDOWNLOADSDB','Azzera voti sui Downloads');
define('_BROKENDOWNLOADSREP','Segnalazioni sui Downloads errati');
...
define('_DOWNLOADVALIDATION','Convalida dei Download');
define('_CHECKALLDOWNLOADS','Controlla TUTTI i Downloads');
define('_VALIDATEDOWNLOADS','Convalida i Downloads');
...
define('_DESCRIPTION255','Descrizione: (massimo 255 caratteri)');
define('_MODCATEGORY','Modifica una categoria');
define('_ADDEDITORIAL','Aggiungi un Editoriale');
define('_EDITORIALTITLE','Titolo dell\'Editoriale');
define('_EDITORIALTEXT','Testo dell\'Editoriale');
...
define('_ALREADYEXIST','gi&#224; esiste!');
...
if (!defined('_DOWNLOADTITLE')) define('_DOWNLOADTITLE','Titolo Download');
