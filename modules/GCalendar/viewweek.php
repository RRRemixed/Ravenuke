...
function viewWeek($year, $month, $day, $printable) {
	...
	echo '<td align="center" valign="middle" width="38%"><b>' . $targetTitle . '</b></td>';
	...
	echo '<tr>';
	for ($j = 0; $j < 7; ++$j) {
		echo '<th width="14%" height="20" valign="middle" align="center"><b>' . dayName($dayNum) . "</b></th>\n";
		$dayNum = ($dayNum + 1) % 7;
	}
	echo "</tr>\n<tr>";
	...
	if (!$thisWeek) {
		...
		echo '<br /><center>' . $gotoThisWeek . '</center><br />' . "\n";
	}
}
