...
function printTitle($titleImg, $title) {
	if ($titleImg != '') {
		echo '<center><img src="' . $titleImg . '" alt="' . _CAL_IMAGE_ALT . '" border="0" /></center><br/>';
	}
...
function printHeader($curYear, $curMon, $curDay, $config, $year, $month, $printable = false, $day = 0, $event = '', $week = false) {
	...
	echo '<td align="left" valign="middle" width="31%"><b>' . _HEADER_TODAYS_DATE . '</b> ' . $gotoToday . "</td>\n";
	echo '<td align="center" valign="middle" width="38%"><b>' . _HEADER_MONTH . '</b> ';

	echo monthCombo('m', $month);
	echo '<b>' . _HEADER_YEAR . '</b> ';
