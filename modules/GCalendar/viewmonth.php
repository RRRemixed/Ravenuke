...
function viewMonth($year = 0, $month = 0, $printable = false) {
	...
	echo '<tr>';
	for ($j = 0; $j < 7; ++$j) {
		echo '<th width="14%" height="20" valign="middle" align="center"><b>' . dayName($dayMap[$j]) . "</b></th>\n";
	}
	echo "</tr>\n";
	...
	echo (!empty($gotoThisMonth))?"<br /><center>$gotoThisMonth</center><br />\n":'';
}
