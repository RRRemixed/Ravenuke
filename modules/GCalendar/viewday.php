...
function viewDay($year, $month, $day, $event, $printable) {
	...
	echo '<td align="center" valign="middle" width="38%"><b>' . $todayTitle . '</b></td>';
	...
	if ($displaySingleEvent) {
		...
		echo '<br /><center><a href="' . viewDayHref($year, $month, $day, '', $printable) . '">' . 
			_VIEW_DAY_VIEW_ALL . '</a></center><br />' . "\n";
	} else {
		if (count($events) > 0) {
			...
			echo '<br /><br /><center>' . _VIEW_DAY_NO_EVENTS . '</center><br /><br />';
		}
	}
}
