...
/**************************************************************************/
//if(!defined('_ALLTOPICS')) { define('_ALLTOPICS','Tous les Sujets'); }
define('_ALL','Tous');
define('_ALLAUTHORS','Tous les Auteurs');
define('_ARTICLES','L \'articles');
...
if(!defined('_SEARCHUSERS')) define('_SEARCHUSERS','Rechercher dans la base de donn&eacute;es des utilisateurs');
...
//if (!defined('_CONTRIBUTEDBY')) { define('_CONTRIBUTEDBY','Contribution de'); }
?>