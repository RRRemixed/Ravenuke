...
if (!defined('_ACTIVATEPAGE')) define('_ACTIVATEPAGE','Aktiviere diese Seite?');
//define('_ACTIVE','Aktiv');
//define('_ADD','Hinzuf&uuml;gen');
if (!defined('_CURRENTSTATUS')) define('_CURRENTSTATUS','Derzeitiger Status');
...
//define('_NO','Nein');
if (!defined('_PAGEBREAK')) define('_PAGEBREAK','Wenn Sie mehrere Seiten m&ouml;chten, f&uuml;gen Sie bitte <b>&lt;!--pagebreak--&gt;</b> f&uuml;r einen Seitenumbruch ein.');
...
if (!defined('_TERMS')) define('_TERMS','Bezeichnungen');
