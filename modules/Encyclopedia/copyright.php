...
function show_copyright() {
   ...
   ."$module_name module for <a href=\"http://phpnuke.org\" target=\"new\">PHP-Nuke</a><br /><br /></font></center>\n"
   ...
   ."<img src=\"../../images/arrow.gif\" border=\"0\" alt=\"\" />&nbsp;<strong>Author's Email:</strong> $author_email<br /><br /></font>\n"
   ."<center><font size=\"2\" color=\"#363636\" face=\"Verdana, Helvetica\">\n[ <a href=\"$author_homepage\" target=\"new\">Author's HomePage</a> | <a href=\"$download_location\" target=\"new\">Module's Download</a> | <a href=\"javascript:void(0)\" onClick=javascript:self.close()>Close</a> ]\n"
   ."</font></center>\n"
   ."</body>\n"
   ."</html>";
}
