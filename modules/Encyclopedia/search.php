...
if ((isset($query) AND !isset($eid)) AND (!empty($query))) {
    ...
    echo '<center><p><b>'._SEARCHRESULTSFOR.' <i>'.$query.'</i></b></p></center>'
        .'<p><i><b>'._RESULTSINTERMTITLE.'</b></i></p><p>';
    ...
    echo '</p><p><i><b>'._RESULTSINTERMTEXT.'</b></i></p><p>';
    if ($numrows == 0) {
        echo _NORESULTSTEXT;
    } else {
    ...
    OpenTable();
    echo '<table border="0" cellspacing="0" cellpadding="10" width="100%"><tr><td>';
    echo '<center><p>'._SEARCHNOTCOMPLETE.'</p>'
