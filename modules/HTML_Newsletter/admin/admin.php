...
if ( isset( $advanced_editor ) && $advanced_editor == 1 && $msnl_gasModCfg['wysiwyg_on'] == 1 ) {
	...
	echo htmlentities(stripslashes( $_POST['msnl_textbody'] ), ENT_QUOTES)."</textarea>\n";
	echo "</td>\n</tr>\n";
	echo "</table>\n";
...
if ( $_POST['msnl_stats'] == "yes") { echo " checked=\"checked\""; }
...
if ( $_POST['msnl_toc'] == "yes") { echo " checked=\"checked\""; }
