...
define('_MSNL_ADM_HLP_TOPIC', 						'Ce texte remplace le tag {EMAILTOPIC} dans le template choisi.  Ce tag est habituellement sur une seule ligne, il est souhaitable qu\'il ne soit pas trop long - 40 caractères ou moins.  Seuls les tags HTML suivants sont autorisé pour ce champ : & lt;b& gt; & lt;i& gt; & lt;u& gt;.');
define('_MSNL_ADM_HLP_SENDER', 						'Ce texte remplace le tag {SENDER} dans le template choisi.  Ce tag est habituellement sur une seule ligne, il est recommandé qu\'il soit cout et personnel - moins de 20 caractères.  Seuls les tags HTML suivants sont autorisé pour ce champ : & lt;b& gt; & lt;i& gt; & lt;u& gt;.');
...
define('_MSNL_ADM_HLP_TEMPLATES',					'La liste ci-dessous correspond à l\'ensemble de mises en page présentent dans le répertoire modules/HTML_Newsletter/templates/. Si vous choisissez d\'envoyer votre lettre d\'information en choisissant <b>no template</b>, seul le texte écrit plus haut apparaîtra dans votre lettre.<br /><br />Pour créer une lettre avec une mise en forme, sélectionnez en une parmis la liste ci-dessous. Vous pouvez avoir un apperçu de cette mise en page en cliquant sur le petit icône citué à droite du nom de la mise en page.<br /><br />Vous pouvez créer vos propre mise en page en choisissant comme modèle <b>Fancy_Content</b> ce dernier étant le seul modèle créé par le créateur du module.');
...
define('_MSNL_ADM_SEND_MSG_TOTALSENT',				'Total de lettres envoyés');
...
define('_MSNL_CAT_HLP_CATBLOCKLMT',					'Ce champ n\'est utilisé seulement si le champ <b>afficher les catégories</b> est activé et doit être supérieure à zéro. Entrez le nombre de lettre d\'information à afficher dans le bloc pour cette catégorie. Si aucune valeur n\'est fournie, elle sera par défaut de ');
...
define('_MSNL_NLS_CHG_HLP_NSNGRPS', 				'Requier que l\'option ci-dessus soit placé sur 4 pour \'groupe NSN seulemenr\'. Chaque groupe NSN à un champ spécifique d\'identification. Au moment de créer et d\'envoyer une lettre d\'information, il est possible de choisir un ou plusieurs groupes NSN destinataire de la lettre. Pour seulement un groupe ce champ ne devrait avoir qu\'un seul ID de groupe. Pour plus d\'un groupe, chaque ID identifiant les groupes doivent être séparé par un tiret, par exemple : <b>1-2-3</b>');
