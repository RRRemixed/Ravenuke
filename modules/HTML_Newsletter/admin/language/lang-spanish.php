...
define('_MSNL_ADM_HLP_TOPIC', 				'Este texto rremplaza la etiqueta {EMAILTOPIC} en la '
  ...
  .'mantenerla precisa y concisa - digamos unos 40 caracteres o menos.  Solo el siguiente '
  .'c&oacute;digo HTML ser&aacute; permitido en este campo: & lt;b& gt; & lt;i& gt; & lt;u& gt;.'
  );
define('_MSNL_ADM_HLP_SENDER', 				'Este texto rremplaza la etiqueta {SENDER} en la '
  .'plantilla seleccionada.  Como esta etiqueta normalmente en una linea con otras etiquetas, Lo mejor ser&iacute;a '
  .'mantenerla concisa y personal - digamos, menos de 20 caracteres.  Solo el siguiente '
  .'c&oacute;digo HTML ser&aacute; permitido en este campo: & lt;b& gt; & lt;i& gt; & lt;u& gt;.'
  );
...
define('_MSNL_ADM_HLP_TEXTBODY',					'Aqu&iacute; es donde va el texto principal de tu bolet&iacute;n. '
  ...
  .'Para textos de bolet&iacute;n largos, talvez desee utilizar etiquetas de anclaje para <b>marcar</b> '
  .'ciertas secciones. No olvide darles nombres descriptivos y luego seleccionar la casilla <b>Incluir Tabla de '
  .'Contenidos</b> y estos anclajes se convertir&aacute;n en enlaces dentro de la tabla de '
  .'contenidos dentro de su bolet&iacute;n! <br /><br />Por ejemplo, podriamos utilizar: '
  .'<b>& lt;a name=\'Primera Secci&oacute;n\'& gt;& lt;/a& gt;</b>. <b>NOTA:</b> Debe ser EXACTAMENTE como se muestra '
  .'con comillas dobles y el cierre de la etiqueta de anclaje! Este ejemplo producir&aacute; un enlace llamado '
  .'<b>Primer Secci&oacute;n</b> dentro de la tabla de contenidos y al presionar sobre el, llevar&aacute; '
...
define('_MSNL_ADM_HLP_TEMPLATES',					'La lista actual deriva de la actual '
  ...
  .'Si elijes trabajar <b>sin plantilla</b>, el sistema simplemente enviar&aacute; un correo a los recipientes '
  .'con el texto introducido anteriorm en el are de texto<b>Texto del bolet&iacute;n</b>.<br /><br />'
  .'Para crear un bolet&iacute;n desde una plantilla, seleccione una de la lista. Para ver un ejemplo de como '
  .'el bolet&iacute;n seleccionado se visualizar&aacute;, presione en el icono <b>Ver</b> a la derecha del '
  .'texto del nombre de la plantilla.<br /><br />Adicionalmente puede crear sus propias plantillas y col&oacute;quelas '
  .'en el directorio de plantillas.  <b>Pista:</b> Escoja como patr&oacute;n Fancy_Content ya que es la '
...
define('_MSNL_ADM_HLP_INCLTOC',						'Al seleccionar esta opci&oacute;n se incluir&aacute; un bloque de una Tabla de '
  ...
  .'para Fancy_Content.  El bloque TOC tendr&aacute; enlaces a cada uno de los bloques de <b>&Uacute;ltimos xxxxxx</b> '
  .'as&iacute; como enlaces a alg&uacute;n otro <b>anclaje</b> inclu&iacute;do dentro del area de texto <b>Texto del bolet&iacute;n</b>.'
  );
...
define('_MSNL_ADM_HLP_WHOSNDTOADM',				'Esta opci&oacute;n enviar&aacute; un bolet&iacute;n de prueba '
  ...
  .'ser enviado a los destinatarios deseados, utilice el enlace <b>Enviar Comprobado</b> en la '
...
define('_MSNL_CFG_HLP_DEBUGMODE',					'Esto le permite al administrador del m&oacute;dulo establecer varios niveles de '
  ...
  .'ya que esto puede proveer mucha informacion bastante &uacute;til a un atacante!). <b>NOTA: Los correos '
  .'no ser&aacute;n enviados utilizando esta opci&oacute;n</b> - Muy &uacute;til para prop&oacute;sitos de depuraci&oacute;n.'
  );
...
define('_MSNL_CAT_HLP_CATBLOCKLMT',				'Este campo es utilizado solamente si la opci&oacute;n <b>mostrar categor&iacute;as</b> '
  .'est&aacute; seleccionada, adem&aacute;s debe ser superior a cero. Introduzca aqu&iacute; el n&uacute;mero de '
  .'boletines que se mostrar&aacute;n bajo esta categor&iacute;a en el bloque. <b>Si no se proporciona '
...
define('_MSNL_NLS_CHG_HLP_NSNGRPS', 			'Requiere que la anterior opci&oacute;n <b>ver</b> '
  ...
  .'Para m&aacute;s de un grupo, cada ID de grupo debe ser separado por un gui&oacute;n, ej. <b>1-2-3</b>.'
  );
