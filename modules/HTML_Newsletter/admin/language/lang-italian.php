...
define('_MSNL_COM_HLP_ACTIONS',						'Hover the cursor over each icon below to see what action is going to be taken if it is clicked.');
...
define('_MSNL_CFG_HLP_DLMODULE',					'Replace this with the proper module '
  ...
  .'<strong>downloads</strong>_downloads. For NSN GR Downloads module, it is \'nsngd\' '
