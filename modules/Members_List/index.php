...
$sql = "SELECT username, user_color_gc, user_id, user_viewemail, user_posts, user_regdate, user_from, user_from_flag, user_website, user_email, user_fb, user_tw, user_skype, user_steam, user_avatar, user_avatar_type, user_allowavatar
	FROM " . USERS_TABLE . "
