...
if(is_admin($admin)) {
   ...
   echo '<b>Conversion complete</b><br /><br />'.PHP_EOL;
   echo '<b>Please delete this script from your server now.</b><br /><br />'.PHP_EOL;
} else {
   echo '<b>You must be admin to run this script</b><br /><br />'.PHP_EOL;
}
