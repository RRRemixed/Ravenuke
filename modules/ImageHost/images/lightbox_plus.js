...
addEvent(window,"load",function() {
	var lightbox = new LightBox({
		loadingimg:'modules/ImageHost/images/loading.gif',
		expandimg:'modules/ImageHost/images/expand.gif',
		shrinkimg:'modules/ImageHost/images/shrink.gif',
		effectimg:'modules/ImageHost/images/jotos.gif',
		effectpos:{x:-40,y:-20},
		effectclass:'effectable',
		closeimg:'modules/ImageHost/images/close.gif'
	});
});