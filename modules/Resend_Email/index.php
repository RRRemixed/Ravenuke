 ...
 * ===========================
 *
* Copyright (c) 2008-2009 by Raven Web Services LLC
...
extract($HTTP_POST_VARS, EXTR_SKIP); //Raven v2.30.01 per Janek Vind
...
if (isset($submit) && htmlentities($submit) == _LBLBTNRESEND) {
    ...
    if (defined('TNML_IS_ACTIVE')) {
        ...
        $rc_email = tnml_fMailer($to, $subject, $message, $from, $sitename);
    } else {
