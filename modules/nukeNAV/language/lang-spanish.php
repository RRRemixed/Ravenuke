...
if (!defined('_NAV_VARIABLES_HLP')) define('_NAV_VARIABLES_HLP','Varias variables est&aacute;n disponibles para su uso en las etiquetas HEAD:<br /><ul><li><b>%sitename%</b> - El nombre del sitio guardado en la Configuraci&oacute;n del Sitio</li><li><b>%slogan%</b> - El lema del sitio guardado en la Configuraci&oacute;n del Sitio</li><li><b>%module%</b> - El t&iacute;tulo del m&oacute;dulo actual</li><li><b>%year%</b> - El a&ntilde;o actual en formato gregoriano de 4 d&iacute;gitos (por ejemplo 2009 para Derechos de Autor)</li></ul>Estas variables van todo en min&uacute;sculas y deben ser precedidas y sucedidas por el s&iacute;mbolo %.');
if (!defined('_NAV_LEVEL')) define('_NAV_LEVEL','Nivel de la Etiqueta HEAD');
if (!defined('_NAV_LEVEL_HLP')) define('_NAV_LEVEL_HLP','Las etiquetas HEADpueden ser generadas y redefinidas en los siguientes niveles utilizando el m&aacute;s alto nivel de detalle aplicable:<br /><br />0. <b>Sitio</b> (p&aacute;gina de inicio)<br />1. <b>M&oacute;dulo</b><br />2. <b>Categor&iacute;a</b> (ej. Categor&iacute;a del Foro)<br />3. <b>Subcategor&iacute;a</b> (ej. Foro)<br />4. <b>Contenido</b> (ej. Tema del Foro, Art&iacute;culo de Noticias)<br /><br />Nota: Las redefiniciones de sitio son requeridas y no  pueden ser eliminadas.');
