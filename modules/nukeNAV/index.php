...
function nukeNAVlogin() {
	...
	$content .= '<center><font class="content">'._NICKNAME.'&nbsp;<input type="text" name="username" size="15" maxlength="25" /><br />';
	...
	$content .= '<input id="login_submit" type="submit" alt="login" value="'._LOGIN.'" /></font></center></form>';
	return $content;
}
...
function nukeNAVSEO() {
	...
	$content .= '<br /><center><table width="100%" border="0" cellspacing="0" cellpadding="0">'."\n"
