...
//    if (!isset($assotop)) $assotop = ''; set above
    previewAdminStory($automated, $year, $day, $month, $hour, $min, $subject, $hometext, $bodytext, $tags, $topic, $catid, $ihome, $alanguage, $acomm, $pollTitle, $optionText, $assotop);
    break;

    case 'PostAdminStory':
    postAdminStory($automated, $year, $day, $month, $hour, $min, $subject, $hometext, $bodytext, $tags, $topic, $catid, $ihome, $alanguage, $acomm, $pollTitle, $optionText, $assotop);
    break;
...
$result2 = $db->sql_query("DELETE FROM ".$prefix."_tags WHERE whr=3 AND cid='$qid'");
...
//          .'<textarea wrap="virtual" cols="50" rows="12" name="hometext">.$hometext.'</textarea><br /><br />'
        wysiwyg_textarea('hometext', "$hometext", 'NewsAdmin', 50, 12);
...
//      .'<textarea wrap="virtual" cols="50" rows="7" name="hometext">'.$story.'</textarea><br /><br />'
    wysiwyg_textarea('hometext', "$story", 'NewsAdmin', 50, 7);
...
//      .'<textarea wrap="virtual" cols="50" rows="7" name="hometext">'.$hometext.'</textarea><br /><br />'
    wysiwyg_textarea('hometext', "$hometext", 'NewsAdmin', 50, 7);
    echo '<br /><br /><b>'._EXTENDEDTEXT.'</b><br />';
...
function editStory($sid) {
    ...
    if (($radminarticle == 1) AND ($aaid == $aid) OR ($radminsuper == 1)) {
        ...
        echo '<br /><br /><b>'._STORYTEXT.'</b><br />';
//          .'<textarea wrap="virtual" cols="50" rows="7" name="hometext">'.$hometext.'</textarea><br /><br />'
        wysiwyg_textarea('hometext', "$hometext", 'NewsAdmin', 50, 17);
        echo '<br /><br /><b>'._EXTENDEDTEXT.'</b><br />';
//          .'<textarea wrap="virtual" cols="50" rows="10" name="bodytext">'.$bodytext.'</textarea><br />'
        wysiwyg_textarea('bodytext', "$bodytext", 'PHPNukeAdmin', 50, 10);
        echo '<br /><font class="content">'._AREYOUSURE.'</font><br /><br />'
...
//      .'<textarea wrap="virtual" cols="50" rows="12" name="hometext"></textarea><br /><br />'
    wysiwyg_textarea('hometext', '', 'NewsAdmin', 50, 12);
    echo '<br /><br /><b>'._EXTENDEDTEXT.'</b><br />';
...
function previewAdminStory($automated, $year, $day, $month, $hour, $min, $subject, $hometext, $bodytext, $tags, $topic, $catid, $ihome, $alanguage, $acomm, $pollTitle, $optionText, $assotop) {
...
function postAdminStory($automated, $year, $day, $month, $hour, $min, $subject, $hometext, $bodytext, $tags, $topic, $catid, $ihome, $alanguage, $acomm, $pollTitle, $optionText, $assotop) {
    global $ultramode, $aid, $prefix, $db, $admin_file;
    $associated = '';
    if (!empty($assotop)) {
        $j = sizeof($assotop);
