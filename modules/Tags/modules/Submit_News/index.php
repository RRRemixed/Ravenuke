...
switch($op) {
    ...
    case _OK:
        SubmitStory($name, $address, $subject, $story, $storyext, $tags, $topic, $alanguage, $posttype);
    break;
...
//    ."<textarea cols=\"50\" rows=\"12\" name=\"story\"></textarea><br />"
    wysiwyg_textarea('story', '', 'NewsUser', '50', '12');
...
//       .'<textarea cols="50" rows="12" name="story">$story</textarea><br />'
    ...
    wysiwyg_textarea('story', $story, 'NewseUser', '50', '12');
    echo '</div><div><b>'._EXTENDEDTEXT.':</b><br />';
...
function SubmitStory($name, $address, $subject, $story, $storyext, $tags, $topic, $alanguage, $posttype) {
