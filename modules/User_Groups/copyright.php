...
$author_name = "David Karn";
$author_user_email = "david@halfsane.net";
$author_homepage = "http://www.webdever.net/";
$license = "GNU/GPL";
$download_location = "http://webdever.net/modules.php?name=Downloads";
$module_version = "1.2";
$module_description = "User Groups Module";
