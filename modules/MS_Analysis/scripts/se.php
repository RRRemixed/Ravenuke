...
echo "<tr><td width=\"100%\" colspan=\"$colspan\" align=\"center\" height=\"30\" bgcolor=\"$bgcolor2\"><b>"._MSA_TOP." $max_view "._MSA_GENSENGINES." ("._MSA_GENTOTAL." $totalentries)</b></td></tr>\n";
...
while( (list( $id, $referral, $hits ) = $db->sql_fetchrow( $result ) ) AND ( $counter < $max_view ) ) {
   if( $msa->IsSearchEngine( $referral ) == 1 ) {
      ...
      if( is_admin( $admin ) ) { echo "<td width=\"5%\" height=\"22\"><p align=\"center\"><a href=\"modules.php?name=$module_name&amp;file=index&amp;op=MSAnalysisSEDel&amp;id=$id&amp;screen=$screen&amp;overview=$overview&amp;sortby=$sortby\"><img src=\"modules/$module_name/images/delete.gif\" border=\"0\" align=\"bottom\"></a></td>\n"; }
      echo "<td width=\"35%\" align=\"left\"><font class=\"content\"><b><a target=\"_blank\" href=\"http://$referral\">$referral</a></b></td>\n";
