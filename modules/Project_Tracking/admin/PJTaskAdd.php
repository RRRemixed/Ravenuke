...
$pagetitle = ": "._PJ_TITLE.": "._PJ_TASKS.": "._PJ_TASKADD;
include("header.php");
...
while(list($s_project_id, $s_project_name) = $db->sql_fetchrow($projectlist)){
  //if($s_project_id == $project_id){ $sel = "selected='selected'"; } else { $sel = ""; }
  //echo "<option value='$s_project_id' $sel>$s_project_name</option>\n";
  echo "<option value='$s_project_id'>$s_project_name</option>\n";
}
echo "</select></td></tr>\n";        
