...
echo "<tr><td colspan='3' bgcolor='$bgcolor2' nowrap='nowrap'><b>"._PJ_REQUESTOPTIONS."</b></td></tr>\n";
...
echo "<tr><td><img src='$pjimage' alt='' title='' /></td><td colspan='2' width='100%' nowrap='nowrap'>"._PJ_TOTALREQUESTS.": <b>$requestrows</b></td></tr>\n";
echo "</table>\n";
//CloseTable();
echo "<br />\n";
...
//OpenTable();
echo "<table width='100%' border='1' cellspacing='0' cellpadding='2'>\n";
echo "<tr><td bgcolor='$bgcolor2' width='100%' colspan='2' nowrap='nowrap'><b>"._PJ_REQUESTLIST."</b></td>\n";
