...
echo '<tr><td colspan="2" width="100%" nowrap="nowrap"><b>' . _PJ_REPORTINFO . '</b></td>'."\n";
...
echo '<tr><td align="center"><img src="' . $pjimage . '" alt="" title="" /></td>'."\n";
echo '<td colspan="3" width="100%" nowrap="nowrap">' . _PJ_REPORTEDBY . ': <b>' . $report['submitter_email'] . '</b></td></tr>'."\n";
...
echo '<tr><td colspan="4" width="100%" nowrap="nowrap"><b>' . _PJ_REPORTMEMBERS . '</b></td></tr>'."\n";
