...
echo '<tr><td colspan="3" width="100%" bgcolor="' . $bgcolor2 . '" nowrap="nowrap"><b>' . _PJ_MEMBEROPTIONS . '</b></td></tr>'."\n";
...
echo '<tr><td><img src="' . $pjimage. '" alt="" title="" /></td><td colspan="2" width="100%" nowrap="nowrap">' . _PJ_MEMBERS . ': <b>' . $member_total . '</b></td></tr>'."\n";
echo '</table>'."\n";
echo '<br />'."\n";
echo '<table width="100%" border="1" cellspacing="0" cellpadding="2">'."\n";
echo '<tr><td colspan="2" bgcolor="' . $bgcolor2 . '" width="100%"><b>' . _PJ_MEMBERS . '</b></td><td align="center" bgcolor="' . $bgcolor2 . '"><b>' . _PJ_FUNCTIONS . '</b></td></tr>'."\n";
