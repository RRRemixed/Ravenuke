...
echo "<tr><td colspan='4' width='100%' nowrap='nowrap'><b>"._PJ_PROJECTNAME."</b></td></tr>\n";
...
echo "<tr><td colspan='2' width='100%' nowrap='nowrap'><b>"._PJ_REQUESTINFO."</b></td>\n";
...
echo "<tr><td align='center'><img src='$pjimage' alt='' title='' /></td>\n";
echo "<td colspan='3' width='100%' nowrap='nowrap'>"._PJ_REQUESTEDBY.": <b>".$request['submitter_email']."</b></td></tr>\n";
...
echo "<tr><td colspan='4' width='100%' nowrap='nowrap'><b>"._PJ_REQUESTMEMBERS."</b></td></tr>\n";
if($member_total != 0){
...
echo "<tr><td width='100%' nowrap='nowrap'><b>"._PJ_COMMENTS."</b></td></tr>\n";
if($comment_total > 0){
  while(list($comment_id) = $db->sql_fetchrow($commentresult)) {
    ...
    echo "<tr><td nowrap='nowrap'><b>".$comment['commenter_email']." @ $comment_date</b>";
    echo "</td></tr>\n";
