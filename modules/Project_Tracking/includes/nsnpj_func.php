...
function pjadmin_menu($pjtitle='') {
	...
	echo '<center class="title"><b>' , _PJ_TITLE , ' ' , $pjtitle , '</b></center><br />',"\n";
	echo '<table border="1" align="center" width="100%" cellpadding="2" cellspacing="0">',"\n";
	echo '<tr bgcolor="' , $bgcolor2 , '">',"\n";
	echo '<td align="center" valign="top" width="20%">&nbsp;<b><u>' , _PJ_PROJECTS , '</u></b>&nbsp;</td>',"\n";
	echo '<td align="center" valign="top" width="20%">&nbsp;<b><u>' , _PJ_TASKS , '</u></b>&nbsp;</td>',"\n";
	echo '<td align="center" valign="top" width="20%">&nbsp;<b><u>' , _PJ_REPORTS , '</u></b>&nbsp;</td>',"\n";
	echo '<td align="center" valign="top" width="20%">&nbsp;<b><u>' , _PJ_REQUESTS , '</u></b>&nbsp;</td>',"\n";
	echo '<td align="center" valign="top" width="20%">&nbsp;<b><u>' , _PJ_MEMBERS , '</u></b>&nbsp;</td>',"\n";
	echo '</tr>',"\n";
	echo '<tr>',"\n";
