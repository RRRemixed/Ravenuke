...
if($project['allowreports'] > 0) {
	...
	echo '<tr><td bgcolor="' , $bgcolor2 , '" colspan="2" width="100%" nowrap="nowrap"><b>' , _PJ_REPORTINFO , '</b></td>',"\n";
	...
	echo '<tr><td align="center"><img src="' , $pjimage , '" alt="" title="" /></td>',"\n";
	echo '<td colspan="3" width="100%" nowrap="nowrap">' , _PJ_REPORTEDBY , ': <b><a href="mailto:' , pjencode_email($report['submitter_email']) , '">' , $report['submitter_name'] , '</a></b></td></tr>',"\n";
	...
	echo '<tr><td bgcolor="' , $bgcolor2 , '" colspan="3" width="100%" nowrap="nowrap"><b>' , _PJ_REPORTMEMBERS , '</b></td>',"\n";
	...
	echo '<table border="1" cellpadding="2" cellspacing="0" width="100%">',"\n";
	echo '<tr><td bgcolor="' , $bgcolor2 , '" width="100%" nowrap="nowrap"><b>' , _PJ_COMMENTS , '</b> <b>(</b> <a href="modules.php?name=' , $module_name , '&amp;op=PJReportCommentSubmit&amp;report_id=' , $report_id , '">' , _PJ_COMMENTADD , '</a> <b>)</b></td></tr>',"\n";
