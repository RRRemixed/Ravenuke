...
if($project['allowrequests'] > 0) {
	...
	echo '<tr><td bgcolor="' , $bgcolor2 , '" colspan="4" width="100%" nowrap="nowrap"><b>' , _PJ_PROJECTNAME , '</b></td></tr>',"\n";
	...
	echo '<tr><td bgcolor="' , $bgcolor2 , '" colspan="2" width="100%" nowrap="nowrap"><b>' , _PJ_REQUESTINFO , '</b></td>',"\n";
	...
	echo '<tr><td align="center"><img src="' , $pjimage , '" alt="" title="" /></td>',"\n";
	echo '<td colspan="3" width="100%" nowrap="nowrap">' , _PJ_REQUESTEDBY , ': <b><a href="mailto:' , pjencode_email($request['submitter_email']) , '">' , $request['submitter_name'] , '</a></b></td></tr>',"\n";
	...
	echo '<tr><td align="center"><img src="' , $pjimage , '" alt="" title="" /></td>',"\n";
	echo '<td colspan="3" width="100%" nowrap="nowrap">' , _PJ_SUBMITTED , ': <b>' , $submit_date , '</b></td></tr>',"\n";
	...
	echo '<tr><td align="center"><img src="' , $pjimage , '" alt="" title="" /></td>',"\n";
	echo '<td colspan="3" width="100%" nowrap="nowrap">' , _PJ_MODIFIED , ': <b>' , $modify_date , '</b></td></tr>',"\n";
	echo '<tr><td bgcolor="' , $bgcolor2 , '" colspan="3" width="100%" nowrap="nowrap"><b>' , _PJ_REQUESTMEMBERS , '</b></td>',"\n";
	...
	if(is_admin($admin)) {
		echo '<tr><td bgcolor="' , $bgcolor2 , '" colspan="4" width="100%" nowrap="nowrap"><b>' , _PJ_ADMINFUNCTIONS , '</b></td></tr>',"\n";
	...
	echo '<tr><td bgcolor="' , $bgcolor2 , '" width="100%" nowrap="nowrap"><b>' , _PJ_COMMENTS , '</b> <b>(</b> <a href="modules.php?name=' , $module_name , '&amp;op=PJRequestCommentSubmit&amp;request_id=' , $request_id , '">' , _PJ_COMMENTADD , '</a> <b>)</b></td></tr>',"\n";
	...
	if($comment_total > 0) {
		while(list($comment_id) = $db->sql_fetchrow($commentresult)) {
			...
			echo '<tr><td bgcolor="' , $bgcolor2 , '" nowrap="nowrap"><b><a href="mailto:' , pjencode_email($comment['commenter_email']) , '">' , $comment['commenter_name'] , '</a> @ ' , $comment_date , '</b>';
