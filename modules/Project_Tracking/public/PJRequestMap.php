...
while(list($project_id) = $db->sql_fetchrow($projectresult)) {
	...
	if($project['allowrequests'] > 0) {
		...
		echo '<tr>',"\n";
		echo '<td bgcolor="' , $bgcolor2 , '" colspan="2" width="100%"><b>' , _PJ_PROJECT , '</b></td>',"\n";
		...
		echo '<td align="center" bgcolor="' , $bgcolor2 , '" nowrap="nowrap"><b>' , _PJ_LASTSUBMISSION , '</b></td>',"\n";
		echo '</tr>',"\n";
		...
		if($project['featured'] > 0) {
			$project_title = '<b>' . $project_title . '</b>';
		}
		...
		echo '</tr>',"\n";
		echo '<tr>',"\n";
		echo '<td bgcolor="' , $bgcolor2 , '" colspan="3"><b>' , _PJ_REQUESTS , '</b></td>',"\n";
