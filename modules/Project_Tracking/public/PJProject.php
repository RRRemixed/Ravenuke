...
echo '<tr><td bgcolor="' , $bgcolor2 , '" width="100%" colspan="2" nowrap="nowrap"><b>' , _PJ_PROJECTNAME , '</b></td>',"\n";
echo '<td align="center" bgcolor="' , $bgcolor2 , '" nowrap="nowrap"><b>' , _PJ_STATUS , '</b></td>',"\n";
echo '<td align="center" bgcolor="' , $bgcolor2 , '" nowrap="nowrap"><b>' , _PJ_PRIORITY , '</b></td>',"\n";
echo '<td align="center" bgcolor="' , $bgcolor2 , '" nowrap="nowrap"><b>' , _PJ_PROGRESSBAR , '</b></td>',"\n";
echo '<td align="center" bgcolor="' , $bgcolor2 , '" nowrap="nowrap"><b>' , _PJ_MEMBERS , '</b></td></tr>',"\n";

if($project['featured'] > 0) {
	$project['project_name'] = '<b>' . $project['project_name'] . '</b>';
}
...
echo '<tr><td align="center"><img src="' , $pjimage , '" alt="" title="" /></td><td width="100%" colspan="5" nowrap="nowrap">' , _PJ_TASKS . ': <b>' , $project_tasks , '</b>&nbsp;&nbsp;/&nbsp;&nbsp;' , _PJ_REPORTS , ': <b>' , $project_reports , '</b>&nbsp;&nbsp;/&nbsp;&nbsp;' , _PJ_REQUESTS , ': <b>' , $project_requests , '</b></td></tr>';
...
echo '<tr><td align="center"><img src="' , $pjimage , '" alt="" title="" /></td>',"\n";
echo '<td width="100%" colspan="5" nowrap="nowrap">' , _PJ_STARTDATE , ': <b>' , $start_date , '</b></td></tr>',"\n";
...
echo '<tr><td align="center"><img src="' , $pjimage , '" alt="" title="" /></td>',"\n";
echo '<td width="100%" colspan="5" nowrap="nowrap">' , _PJ_FINISHDATE , ': <b>' , $finish_date , '</b></td></tr>',"\n";
echo '<tr><td bgcolor="' , $bgcolor2 , '" colspan="4" nowrap="nowrap"><b>' , _PJ_PROJECTMEMBERS , '</b></td>',"\n";
echo '<td align="center" bgcolor="' , $bgcolor2 , '" colspan="2" nowrap="nowrap"><b>' , _PJ_POSITION , '</b></td></tr>',"\n";
...
if($member_total != 0) {
	...
	echo '<tr><td colspan="6" nowrap="nowrap"><center>' , _PJ_NOPROJECTMEMBERS , '</center></td></tr>',"\n";
}

if(is_admin($admin)) {
	echo '<tr><td bgcolor="' , $bgcolor2 , '" colspan="6" width="100%" nowrap="nowrap"><b>' , _PJ_ADMINFUNCTIONS , '</b></td></tr>',"\n";
...
echo '<tr>',"\n";
echo '<td colspan="2" bgcolor="' , $bgcolor2 , '" width="100%" nowrap="nowrap"><b>' , _PJ_TASKS . '</b></td>',"\n";
echo '<td align="center" bgcolor="' , $bgcolor2 , '" nowrap="nowrap"><b>' , _PJ_STATUS , '</b></td>',"\n";
echo '<td align="center" bgcolor="' , $bgcolor2 , '" nowrap="nowrap"><b>' , _PJ_PRIORITY , '</b></td>',"\n";
echo '<td align="center" bgcolor="' , $bgcolor2 , '" nowrap="nowrap"><b>' , _PJ_PROGRESSBAR , '</b></td>',"\n";
echo '<td align="center" bgcolor="' , $bgcolor2 , '" nowrap="nowrap"><b>' , _PJ_MEMBERS , '</b></td>',"\n";
echo '</tr>',"\n";
...
if($task_total != 0) {
	...
	echo '<b>' , _PJ_SORT , ':</b> <select name="column1">',"\n";
...
if($project['allowreports'] > 0) {
	...
	echo '<tr><td bgcolor="' , $bgcolor2 , '" colspan="2" width="100%" nowrap="nowrap"><b>' , _PJ_REPORTS , '</b></td>',"\n";
	echo '<td align="center" bgcolor="' , $bgcolor2 , '" nowrap="nowrap"><b>' , _PJ_TYPE , '</b></td>',"\n";
	echo '<td align="center" bgcolor="' , $bgcolor2 , '" nowrap="nowrap"><b>' , _PJ_STATUS , '</b></td>',"\n";
	echo '<td align="center" bgcolor="' , $bgcolor2 , '" nowrap="nowrap"><b>' , _PJ_SUBMITTED , '</b></td>',"\n";
	echo '<td align="center" bgcolor="' , $bgcolor2 , '" nowrap="nowrap"><b>' , _PJ_COMMENTS , '</b></td></tr>',"\n";
	...
	if($report_total != 0) {
		...
		echo '<input type="hidden" name="op" value="PJProject" />',"\n";
		echo '<input type="hidden" name="project_id" value="' , $project_id , '" />',"\n";
		echo '<b>' , _PJ_SORT , ':</b> <select name="column2">',"\n";
...
if($project['allowrequests'] > 0) {
	...
	echo '<tr><td bgcolor="' , $bgcolor2 , '" colspan="2" width="100%" nowrap="nowrap"><b>' , _PJ_REQUESTS , '</b></td>',"\n";
	echo '<td align="center" bgcolor="' , $bgcolor2 , '" nowrap="nowrap"><b>' , _PJ_TYPE , '</b></td>',"\n";
	echo '<td align="center" bgcolor="' , $bgcolor2 , '" nowrap="nowrap"><b>' , _PJ_STATUS , '</b></td>',"\n";
	echo '<td align="center" bgcolor="' , $bgcolor2 , '" nowrap="nowrap"><b>' , _PJ_SUBMITTED , '</b></td>',"\n";
	echo '<td align="center" bgcolor="' , $bgcolor2 , '" nowrap="nowrap"><b>' , _PJ_COMMENTS , '</b></td></tr>',"\n";
	...
	if($request_total != 0) {
		...
		echo '<input type="hidden" name="op" value="PJProject" />',"\n";
		echo '<input type="hidden" name="project_id" value="' , $project_id , '" />',"\n";
		echo '<b>' , _PJ_SORT , ':</b> <select name="column3">',"\n";
