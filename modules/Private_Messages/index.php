...
{ 
   ...
   include($phpbb_root_path . 'includes/page_tail.'.$phpEx); 
	...
	//
	$sql = "SELECT u.user_color_gc AS color1, u2.user_color_gc AS color2, u.username AS username_1, u.user_id AS user_id_1, u2.username AS username_2, u2.user_id AS user_id_2, u.user_sig_bbcode_uid, u.user_posts, u.user_from, u.user_website, u.user_email, u.user_fb, u.user_tw, u.user_skype, u.user_steam, u.user_regdate, u.user_viewemail, u.user_rank, u.user_sig, u.user_avatar, pm.*, pmt.privmsgs_bbcode_uid, pmt.privmsgs_text
...
#==== v1.0.5 =========================================================== |
#====
	$username_to = CheckUsernameColor($privmsg['color2'], $privmsg['username_2']);
#====
#==== Author: aUsTiN [austin@phpbb-amod.com] [http://phpbb-tweaks.com] = |
#==== End: ==== Advanced Username Color ================================ |	
#======================================================================= |
	...
	$fb_img = ( $privmsg['user_fb'] ) ? '<a href="' . $privmsg['user_fb'] . '" target="_blank"><img src="' . $images['icon_fb'] . '" alt="' . $lang['Visit_fb'] . '" title="' . $lang['Visit_fb'] . '" border="0" /></a>' : '';
	$fb = ( $privmsg['user_fb'] ) ? '<a href="' . $privmsg['user_fb'] . '" target="_blank">' . $lang['Visit_fb'] . '</a>' : '';

	$tw_img = ( $privmsg['user_tw'] ) ? '<a href="' . $privmsg['user_tw'] . '" target="_blank"><img src="' . $images['icon_tw'] . '" alt="' . $lang['Visit_tw'] . '" title="' . $lang['Visit_tw'] . '" border="0" /></a>' : '';
	$tw = ( $privmsg['user_tw'] ) ? '<a href="' . $privmsg['user_tw'] . '" target="_blank">' . $lang['Visit_tw'] . '</a>' : '';

	$skype_img = ( $privmsg['user_skype'] ) ? '<a href="' . $privmsg['user_skype'] . '" target="_blank"><img src="' . $images['icon_skype'] . '" alt="' . $lang['Visit_skype'] . '" title="' . $lang['Visit_skype'] . '" border="0" /></a>' : '';
	$skype = ( $privmsg['user_skype'] ) ? '<a href="' . $privmsg['user_skype'] . '" target="_blank">' . $lang['Visit_skype'] . '</a>' : '';

	$steam_img = ( $privmsg['user_steam'] ) ? '<a href="' . $privmsg['user_steam'] . '" target="_blank"><img src="' . $images['icon_steam'] . '" alt="' . $lang['Visit_steam'] . '" title="' . $lang['Visit_steam'] . '" border="0" /></a>' : '';
	$steam = ( $privmsg['user_steam'] ) ? '<a href="' . $privmsg['user_steam'] . '" target="_blank">' . $lang['Visit_steam'] . '</a>' : '';
...
$sql_tot = "SELECT COUNT(privmsgs_id) AS total
			FROM " . PRIVMSGS_TABLE . " ";
$sql = "SELECT pm.privmsgs_type, pm.privmsgs_id, pm.privmsgs_date, pm.privmsgs_subject, u.user_id, u.username, u.user_color_gc
		FROM " . PRIVMSGS_TABLE . " pm, " . USERS_TABLE . " u ";
...
#==== v1.0.5 =========================================================== |
#====
		$msg_username = CheckUsernameColor($row['user_color_gc'], $row['username']);
#====
#==== Author: aUsTiN [austin@phpbb-amod.com] [http://phpbb-tweaks.com] = |
#==== End: ==== Advanced Username Color ================================ |	
#======================================================================= |
