...
SET challenged=".$xdb->qstr(leaguemod_challengedby.$challenger['name'])."  
WHERE name=".$xdb->qstr($challenged['name'])."  
AND ladder_id=".$xdb->qstr($event['sid']));

modifysql("UPDATE", X1_DB_teamsevents, "
SET challenged=".$xdb->qstr(leaguemod_challenged.$challenged['name'])."  
