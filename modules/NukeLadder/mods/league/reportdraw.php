...
challenged ='".leaguemod_drawvs."$winner', 
...
draws=draws+1,
totaldraws=totaldraws+1,
challenged ='".leaguemod_drawvs."$loser', 
points=points+$event[pointsdraw], 
totalpoints=totalpoints+$event[pointsdraw], 
games=games+1, totalgames=totalgames+1, 
streakwins=0, streaklosses=streaklosses=0 
...
(laddername, winner, loser, date, comments, map1, map2, map3, map1t1, map1t2, map2t1, map2t2, map3t1, map3t2, demo, draw)
VALUES 
(
".$xdb->qstr($event['sid']).", 
".$xdb->qstr($winner).", 
...
$c .= X1plugin_title(leaguemod_drawreported);
?>