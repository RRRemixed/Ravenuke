...
echo "<form action='modules.php?name=$module_name&amp;op=edithardware&amp;edit=1' ENCTYPE='multipart/form-data' method='POST'>";
...
if($hardimage != ""){
echo "<br /><b>Current</b>&nbsp;$hardimage&nbsp;[&nbsp;<a href='modules.php?name=$module_name&amp;op=edithardware&amp;hardimage=$hardimage&amp;deleteimage=1'>Delete</a>&nbsp;]";
}
echo "</td>\n";
echo "</tr>";}
if($crfig[uboard] == 1){
