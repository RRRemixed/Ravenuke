...
Function MetAuthorsColumnists(){
   ...
   OpenTable();
   echo "<tr><td colspan=\"6\"><b>Author List:</b></td></tr>";
   echo "<tr><td><b></b></td><td><b>Author's Bio</b></td><td><b>Info</b></td></tr>";
   ...
   while ($row = $db->sql_fetchrow($result)) {
     ...
     echo "</a></td>"
         ."<td><b>".$authorname."</b><br />"
         .$row['bio']."</td>"
         ."<td>Articles: <b>".$row['totcount']."</b><br /> Reads: ".$row['totreads']."<br /> Avg Reads: ".$row['avgreads']."<br />Avg Rating: <b>".$row['avgrating']."</b>/5.0<br />"
...
//   echo "<p>";
   ...
   OpenTable();
   echo "<b><u>"._SUBMITCONTENT."</u></b><br /><br />";
   ...
   echo "<br />";
   echo "<b><u>"._STATISTICS."</u></b><br /><br />";
...
// the following code is not used yet - Guardian
 ...
 //    echo "<form action=\"modules.php?name=".$module_name."\" method=\"post\">"
  //        ."<b><u>Move an Article to a different author:</u></b><br /><br />"
   //       ."Article Id: <input type=\"text\" name=\"articleid\" size=\"5\" value=\"\" /> "
    //      ."Author: <input type=\"text\" name=\"author\" size=\"15\" value=\"\" /> "
     //     ."<input type=\"hidden\" name=\"maction\" value=\"updateauthors\" />"
      //    ."<input type=\"submit\" value=\"GO\" />"
 ...
 //  }
   /* Quick Stat Overview  */
   echo "<a name=\"qstat\">";
   echo "<b><u>"._QUICKSTATOVERVIEW."</u></b></a><br /><br />";
...
//   echo "<a name=\"tstories30\">";
     OpenTable();
   echo "<table><tr><td colspan=\"6\"><a name=\"tstories30\"><b><u>"._TOPRECENTSTORIES."</u></b></a></td></tr>";
   echo "<tr><td><b>#</b></td><td><b>"._STORYTITLE."</b></td><td><b>"._STORYDATE."</b></td><td><b>"._AUTHORNAME."</b></td><td><b>"._STORYREADS."</b></td><td><b>"._READSPERDAY."</b></td></tr>";
...
//   echo "<a name=\"tstoriesall\">";
   OpenTable();
   echo "<table><tr><td colspan=\"6\"><a name=\"tstoriesall\"><b><u>$top "._READSTORIES."</u></b></a></td></tr>";
   echo "<tr><td><b>#</b></td><td><b>"._STORYTITLE."</b></td><td><b>"._STORYDATE."</b></td><td><b>"._AUTHORNAME."</b></td><td><b>"._STORYREADS."</b></td><td><b>"._READSPERDAY."</b></td></tr>";
...
//   echo "<a name=\"tauthors\">";
   ...
   OpenTable();
   echo "<table><tr><td colspan=\"6\"><a name=\"tauthors\"><b><u>"._TOP." $top "._AUTHORS."</u></b></a></td></tr>";
   echo "<tr><td><b>#</b></td><td><b>"._AUTHORNAME."</b></td><td><b>"._NUMSTORIES."</b></td><td><b>"._STORYREADS."</b></td><td><b>"._STORYAVGREADS."</b></td><td><b>"._READSPERDAY."</b></td><td><b>"._TOTALRATINGS."</b></td><td><b>"._AVGRATINGS."</b></td></tr>";
     $whilectr=1;
     while ($row = $db->sql_fetchrow($result)) {
      echo ($uname==$row['informant'] ? "<tr>" : "<tr>");
      echo "<td>$whilectr</td>"
   ...
   echo "<a name=\"monthlyarticlesoverview\">"
       ."<b><u>"._MONTHLYARTICLEOVERVIEW."</u></b></a><br /><br />";

   $sql = "SELECT left(time,7) as mong, count(*) as mcount FROM `".$prefix."_stories` WHERE 1 group by mong "
       ."order by mong desc ";
   $result = $db->sql_query($sql);
   echo "<table><tr><td><b>"._MONTH."</b></td><td><b>"._STORYREADS."</b></td></tr>";
   $tempVar = '';
   while ($row = $db->sql_fetchrow($result)) {
   ...
   echo "<a name=\"articlecountbytopic\">"
       ."<b><u>"._ARTICLECOUNTBYTOPIC."</u></b></a><br /><br />";
   ...
   //echo $sql;
   $result = $db->sql_query($sql);
   echo "<table><tr><td><b>"._TOPIC."</b></td><td><b>"._NUMSTORIES."</b></td><td><b>"._STORYREADS."</b></td><td><b>"._STORYAVGREADS."</b></td></tr>";
   $tempVar = '';
   while ($row = $db->sql_fetchrow($result)) {
   ...
   echo "<a name=\"articlecountbycategory\">"
       ."<b><u>"._ARTICLECOUNTBYCATEGORY."</u></b></a><br /><br />";
   ...
   //echo "<center><font color=\"$textcolor2\">Extended functions by <b><a href=http://www.phpnuke-service.de>PHPNuke-Service.de</a></b> and <b><a href=http://www.complex-berlin.de>Complex-Berlin.de</a></b></font></center>\n";
//   echo "<center><font color=\"$textcolor2\">Provided by <b><a href=\"http://www.metopen.com\">MetOpen.com</a></b></font></center>\n";
