...
if($numusers > 0) {
	while(list($gid, $gname, $gdesc, $glimit) = $db->sql_fetchrow($result)) {
		echo '<tr><td align="left" bgcolor="'.$bgcolor2.'"><b>'._GR_GRPNAME.':</b></td><td  align="left">'.$gname.' ';
		...
		echo '<tr><td align="left" bgcolor="'.$bgcolor2.'"><b>'._GR_NUMUSERS.':</b></td><td align="left">'.$numusers.'</td></tr>'."\n";
		...
		echo '<tr><td align="left" bgcolor="'.$bgcolor2.'"><b>'._GR_LIMIT.':</b></td><td align="left">'.$gmlimit.'</td></tr>'."\n";
		echo '<tr><td align="left" bgcolor="'.$bgcolor2.'" valign="top"><b>'._GR_DESCRIPTION.':</b></td><td align="left">'.nl2br($gdesc).'</td>'."\n";
		echo '</tr>'."\n";
	}
} else {
