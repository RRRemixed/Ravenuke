...
if ($gid > 0) {
	...
	echo '<center><form method="post" action="' . $admin_file . '.php?op=NSNGroupsUsersAddSave">';
	...
	echo '<tr><td align="center" colspan="2" bgcolor="' . $bgcolor2 . '">' . _GR_ADDUSRTO . ' <a href="' . $admin_file . '.php?op=NSNGroupsUsersView&amp;gid=' . $gid . '"><b>' . $grpName . '</b></a></td></tr>';
	...
	echo '</select><b>/</b><select name="newday"><option value="00">--</option>';
	...
	echo '</select><b>/</b><select name="newyear"><option value="0000">----</option>';
	...
	echo '</select><b>:</b><select name="newmin"><option value="00">--</option>';
	...
	echo '<center><form method="post" action="' . $admin_file . '.php?op=NSNGroupsUsersAdd" onsubmit="return formCheck(this);">';
