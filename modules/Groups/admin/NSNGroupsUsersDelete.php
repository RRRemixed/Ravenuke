...
echo '<center>[ <a class="rn_csrf" href="' . $admin_file . '.php?op=NSNGroupsUsersDeleteConf&amp;gid=' . $gid . '&amp;uid=' . $chng_uid . '">' . _GR_YES . '</a> | <a href="' . $admin_file . '.php?op=NSNGroupsView&amp;gid=' . $gid . '">' . _GR_NO . '</a> ]</center>';
CloseTable();
