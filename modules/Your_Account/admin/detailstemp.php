...
if (($radminsuper==1) OR ($radminuser==1)) {
	...
	if($db->sql_numrows($result) > 0) {
		...
		echo '<tr><td>'._NICKNAME.':</td><td><b><input type="text" value="'.$chnginfo['username'].'" size="40" disabled="disabled" style="color=#000000;background-color: #ffffff" /></b></td></tr>'."\n";
		echo '<tr><td>'._UREALNAME.':</td><td><b><input type="text" value="'.$chnginfo['name'].'" size="40" disabled="disabled" style="color=#000000;background-color: #ffffff" /></b></td></tr>'."\n";
		echo '<tr><td>'._EMAIL.':</td><td><b><a href="mailto:'.$chnginfo['user_email'].'"><input type="text" value="'.$chnginfo['user_email'].'" size="40" disabled="disabled" style="color=#000000;background-color: #ffffff" /></a></b></td></tr>'."\n";
		...
		while ($sqlvalue = $db->sql_fetchrow($result)) {
			...
			while ($tmpsqlvalue = $db->sql_fetchrow($result1)) {
				...
				echo '<tr><td>'.$name_exit.'</td><td><b><input type="text" value="'.$tmp_value.'" size="40" disabled="disabled" style="color=#000000;background-color: #ffffff" /></b></td></tr>'."\n";
			}
		}
