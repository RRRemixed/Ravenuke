...
if (!isset($xusefb)) $xusefb = '';
if (!isset($xusetw)) $xusetw = '';
if (!isset($xuseskype)) $xuseskype = '';
if (!isset($xusesteam)) $xusesteam = '';
...
if (($radminsuper==1) OR ($radminuser==1)) {
    ...
    ya_save_config('usefb', $xusefb);
    ya_save_config('usetw', $xusetw);
    ya_save_config('useskype', $xuseskype);
    ya_save_config('usesteam', $xusesteam);
