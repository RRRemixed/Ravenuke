...
if (($radminsuper==1) OR ($radminuser==1)) {
    ...
    if (!isset($max)) $max=$minamt+$ya_config['perpage'];
    ...
    echo '<tr><td style="color: #000000"><b>'._USERNAME.' ('._USERID.')</b></td>';
    echo '<td align="center" style="color: #000000"><b>'._UREALNAME.'</b></td>';
    echo '<td align="center" style="color: #000000"><b>'._EMAIL.'</b></td>';
    echo '<td align="center" style="color: #000000"><b>'._REGDATE.'</b></td>';
    if ($listtype <> 'w') echo '<td align="center" style="color: #000000"><b>'._YA_LASTVISIT.'</b></td>';
    echo '<td align="center" style="color: #000000"><b>'._FUNCTIONS.'</b></td></tr>';
