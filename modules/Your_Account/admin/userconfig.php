...
#    if (is_active('Legal')) {
  ...
  $objDocTypes = new Legal_DocTypes('', $lang);
	...
	*/
	...
	askregfield2('usewebsite');
	echo '</td></tr>';
	echo '<tr><td align="right">' . _ACTALLOWIMFB . '</td><td align="left">';
	askregfield2('usefb');
	echo '</td></tr>';
	echo '<tr><td align="right">' . _ACTALLOWIMTW . '</td><td align="left">';
	askregfield2('usetw');
	echo '</td></tr>';
	echo '<tr><td align="right">' . _ACTALLOWIMSKYPE . '</td><td align="left">';
	askregfield2('useskype');
	echo '</td></tr>';
	echo '<tr><td align="right">' . _ACTALLOWIMSTEAM . '</td><td align="left">';
	askregfield2('usesteam');
	echo '</td></tr>';
	echo '<tr><td align="right">' . _ACTALLOWLOC . '</td><td align="left">';
	askregfield2('uselocation');
	echo '</td></tr>';
	echo '<tr><td align="right">' . _ACTALLOWOCC . '</td><td align="left">';
	askregfield2('useoccupation');
	echo '</td></tr>';
	echo '</table></td><td>';
	echo '<table border="0" cellpadding="2" cellspacing="2">';
	echo '<tr><td align="right">' . _ACTALLOWINTRSTS . '</td><td align="left">';
	askregfield2('useinterests');
	echo '</td></tr>';
	echo '<tr><td align="right">' . _ACTALLOWNEWSLETTER . '</td><td align="left">';
	askregfield2('usenewsletter');
	echo '</td></tr>';
	echo '<tr><td align="right">' . _ACTALLOWVIEWEMAIL . '</td><td align="left">';
	askregfield2('useviewemail');
	echo '</td></tr>';
	echo '<tr><td align="right">' . _ACTHIDEONLINE . '</td><td align="left">';
	askregfield2('usehideonline');
	echo '</td></tr>';
	...
	echo '</div>';
	echo '</div>';
	echo '<center><input type="hidden" name="op" value="yaUsersConfigSave" />';
