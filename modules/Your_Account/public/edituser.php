...
if ((is_user($user)) AND (strtolower($userinfo['username']) == strtolower($cookie[1])) AND ($userinfo['user_password'] == $cookie[2])) {
	...
	if ($ya_config['usefb'] >= '1') {
		echo '<tr><td><strong>' . _YFB . ':</strong></td>';
		echo '<td><input type="text" name="user_fb" value="' . $userinfo['user_fb'] . '" size="30" maxlength="100" /></td></tr>';
	}
	if ($ya_config['usetw'] >= '1') {
		echo '<tr><td><strong>' . _YTW . ':</strong></td>';
		echo '<td><input type="text" name="user_tw" value="' . $userinfo['user_tw'] . '" size="30" maxlength="100" /></td></tr>';
	}
	if ($ya_config['useskype'] >= '1') {
		echo '<tr><td><strong>' . _YSKYPE . ':</strong></td>';
		echo '<td><input type="text" name="user_skype" value="' . $userinfo['user_skype'] . '" size="30" maxlength="100" /></td></tr>';
	}
	if ($ya_config['usesteam'] >= '1') {
		echo '<tr><td><strong>' . _YSTEAM . ':</strong></td>';
		echo '<td><input type="text" name="user_steam" value="' . $userinfo['user_steam'] . '" size="30" maxlength="100" /></td></tr>';
	}
	...
	if ($ya_config['usesignature'] >= '1') {
		...
		echo '<td><textarea cols="50" rows="5" name="user_sig">' . $signature . '</textarea><br />' . _255CHARMAX . '</td></tr>';
	}
