...
if (($user_id == $vuid) AND ($check2 == $ccpass)) {
	...
	if ($ya_config['usefb'] == '0') $user_fb = '';
	if ($ya_config['usetw'] == '0') $user_tw = '';
	if ($ya_config['useskype'] == '0') $user_skype = '';
	if ($ya_config['usesteam'] == '0') $user_steam = '';
	...
	if ($stop == '') {
		...
		while ($sqlvalue = $db->sql_fetchrow($result)) {
			...
			if (!isset($nfield[$t]) || $nfield[$t] == '') {
				...
				echo '<p class="content" align="center"><span class="title"><b>' . _ERRORREG . '</b></span><br /><br />';
		...
		if ($user_password != '') {
			...
			if (($ya_config['emailvalidate'] == '0') OR ($tuemail == $user_email)) {
				$db->sql_query('UPDATE ' . $user_prefix . '_users SET name=\'' . $realname . '\', user_email=\'' . $user_email . '\', femail=\'' . $femail . '\', user_website=\'' . $user_website . '\', user_password=\'' . $user_password . '\', bio=\'' . $bio . '\', user_occ=\'' . $user_occ . '\', user_from=\'' . $user_from . '\', user_interests=\'' . $user_interests . '\', user_sig=\'' . $user_sig . '\', user_sig_bbcode_uid=\'' . $user_sig_bbcode_uid . '\', user_fb=\'' . $user_fb . '\', user_tw=\'' . $user_tw . '\', user_skype=\'' . $user_skype . '\', user_steam=\'' . $user_steam . '\', newsletter=\'' . $newsletter . '\', user_viewemail=\'' . $user_viewemail . '\', user_allow_viewonline=\'' . $user_allow_viewonline . '\', user_notify=\'' . $user_notify . '\', user_notify_pm=\'' . $user_notify_pm . '\', user_popup_pm=\'' . $user_popup_pm . '\', user_attachsig=\'' . $user_attachsig . '\', user_allowbbcode=\'' . $user_allowbbcode . '\', user_allowhtml=\'' . $user_allowhtml . '\', user_allowsmile=\'' . $user_allowsmile . '\', user_lang=\'' . $user_lang . '\', user_timezone=\'' . $user_timezone . '\', user_dateformat=\'' . $user_dateformat . '\' WHERE user_id=\'' . $user_id . '\'');
			} else {
				$db->sql_query('UPDATE ' . $user_prefix . '_users SET name=\'' . $realname . '\', femail=\'' . $femail . '\', user_website=\'' . $user_website . '\', user_password=\'' . $user_password . '\', bio=\'' . $bio . '\', user_occ=\'' . $user_occ . '\', user_from=\'' . $user_from . '\', user_interests=\'' . $user_interests . '\', user_sig=\'' . $user_sig . '\', user_sig_bbcode_uid=\'' . $user_sig_bbcode_uid . '\', user_fb=\'' . $user_fb . '\', user_tw=\'' . $user_tw . '\', user_skype=\'' . $user_skype . '\', user_steam=\'' . $user_steam . '\', newsletter=\'' . $newsletter . '\', user_viewemail=\'' . $user_viewemail . '\', user_allow_viewonline=\'' . $user_allow_viewonline . '\', user_notify=\'' . $user_notify . '\', user_notify_pm=\'' . $user_notify_pm . '\', user_popup_pm=\'' . $user_popup_pm . '\', user_attachsig=\'' . $user_attachsig . '\', user_allowbbcode=\'' . $user_allowbbcode . '\', user_allowhtml=\'' . $user_allowhtml . '\', user_allowsmile=\'' . $user_allowsmile . '\', user_lang=\'' . $user_lang . '\', user_timezone=\'' . $user_timezone . '\', user_dateformat=\'' . $user_dateformat . '\' WHERE user_id=\'' . $user_id . '\'');
				$datekey = date('F Y');
			...
			$db->sql_query('LOCK TABLES ' . $user_prefix . '_users WRITE, ' . $user_prefix . '_users_field_values WRITE');
			if (($ya_config['emailvalidate'] == '0') OR ($tuemail == $user_email)) {
				$db->sql_query('UPDATE ' . $user_prefix . '_users SET name=\'' . $realname . '\', user_email=\'' . $user_email . '\', femail=\'' . $femail . '\', user_website=\'' . $user_website . '\', bio=\'' . $bio . '\', user_occ=\'' . $user_occ . '\', user_from=\'' . $user_from . '\', user_interests=\'' . $user_interests . '\', user_sig=\'' . $user_sig . '\', user_sig_bbcode_uid=\'' . $user_sig_bbcode_uid . '\', user_fb=\'' . $user_fb . '\', user_tw=\'' . $user_tw . '\',, user_skype=\'' . $user_skype . '\' user_steam=\'' . $user_steam . '\', newsletter=\'' . $newsletter . '\', user_viewemail=\'' . $user_viewemail . '\', user_allow_viewonline=\'' . $user_allow_viewonline . '\', user_notify=\'' . $user_notify . '\', user_notify_pm=\'' . $user_notify_pm . '\', user_popup_pm=\'' . $user_popup_pm . '\', user_attachsig=\'' . $user_attachsig . '\', user_allowbbcode=\'' . $user_allowbbcode . '\', user_allowhtml=\'' . $user_allowhtml . '\', user_allowsmile=\'' . $user_allowsmile . '\', user_lang=\'' . $user_lang . '\', user_timezone=\'' . $user_timezone . '\', user_dateformat=\'' . $user_dateformat . '\' WHERE user_id=\'' . $user_id . '\'');
			} else {
				$db->sql_query('UPDATE ' . $user_prefix . '_users SET name=\'' . $realname . '\', femail=\'' . $femail . '\', user_website=\'' . $user_website . '\', bio=\'' . $bio . '\', user_occ=\'' . $user_occ . '\', user_from=\'' . $user_from . '\', user_interests=\'' . $user_interests . '\', user_sig=\'' . $user_sig . '\', user_sig_bbcode_uid=\'' . $user_sig_bbcode_uid . '\', user_fb=\'' . $user_fb . '\', user_tw=\'' . $user_tw . '\', user_skype=\'' . $user_skype . '\' user_steam=\'' . $user_steam . '\', newsletter=\'' . $newsletter . '\', user_viewemail=\'' . $user_viewemail . '\', user_allow_viewonline=\'' . $user_allow_viewonline . '\', user_notify=\'' . $user_notify . '\', user_notify_pm=\'' . $user_notify_pm . '\', user_popup_pm=\'' . $user_popup_pm . '\', user_attachsig=\'' . $user_attachsig . '\', user_allowbbcode=\'' . $user_allowbbcode . '\', user_allowhtml=\'' . $user_allowhtml . '\', user_allowsmile=\'' . $user_allowsmile . '\', user_lang=\'' . $user_lang . '\', user_timezone=\'' . $user_timezone . '\', user_dateformat=\'' . $user_dateformat . '\' WHERE user_id=\'' . $user_id . '\'');
				$datekey = date('F Y');
				$check_num = substr(md5(hexdec($datekey) * hexdec($cookie[2]) * hexdec($sitekey) * hexdec($user_email) * hexdec($tuemail)) , 2, 10);
				$finishlink = $nukeurl . '/modules.php?name=' . $module_name . '&op=changemail&id=' . $user_id . '&mail=' . $user_email . '&check_num=' . $check_num;
				$message.=_CHANGEMAIL1 . ' ' . $tuemail . ' ' . _CHANGEMAIL2 . ' ' . $user_email . _CHANGEMAIL3 . ' ' . $sitename . "\r\n\r\n";
		...
		include_once 'header.php';
		OpenTable();
		echo '<p align="center" class="content"><span class="title"><b>' . _ERRORREG . '</b></span><br /><br />';
