...
define('_ACCTJOURNAL','I tuoi<br />Journal');
...
define('_ACTALLOWFAKE','Permetti una email falsa:');
...
define('_ACTDISABLED','Questa funzione &egrave; stata <b>DISABILITATA</b> dall\'amministratore del sito.');
define('_ACTERROR','Per favore assicurati che tutti i dati inseriti siano corretti, altrimenti creati un nuovo account <a href=\'modules.php?name=Your_Account\'>qui.</a>');
...
if (!defined('_ERRORINVEMAIL')) define('_ERRORINVEMAIL','ERRORE: email non corretta');
define('_ERRORINVNICK','ERRORE: nickname non corretto');
...
define('_NICKNOSPACES','ERRORE: il nickname non pu&ograve; contenere spazi');
define('_NICKTAKEN','ERRORE: nickname gi&agrave; esistente');
...
if(!defined('_REQUIRED')) define('_REQUIRED','(richiesto)');
...
define('_YA_CURRAV','Attuale Avatar');
...
define('_YA_NICKLENGTH','La lunghezza del nickname deve essere compresa tra i '.$ya_config['nick_min'].' e '.$ya_config['nick_max'].' caratteri.');
...
define('_YACOPPA2','You must be <b>18</b> or over to register for a membership here.');
define('_YACOPPA3','Are you age <b>18</b> or above? <small>Please answer yes or no and click Continue.</small>');
define('_YACOPPA4','Spiacenti! Devi essere <b>maggiorenne</b> per registrarti su questo sito.');
...
define('_YATOSINTRO2','<b>Benvenuto ...<br />Per diventare membro dovrai accettare i Termini di Servizio.</b>');
define('_YATT','Totale');
...
define('_YOUAREPENDING','Benvenuto! Your application as a new member is pending. The site administrator will contact you when your application is processed.');
...
define('_YOURHOMEPAGE','La tua Home Page');
