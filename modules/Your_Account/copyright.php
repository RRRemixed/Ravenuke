...
$license = 'GNU/GPL Copyright &copy; 2008-2009';
$download_location = '';
...
function show_copyright() {
	...
	if (empty($mod_name)) {
		$mod_name = eregi_replace('_', ' ', $module_name);
	}
	...
	echo '<b>Module Copyright &copy; Information</b><br />';
	...
	if ($mod_name != '') {
		echo '<tr><td nowrap="nowrap"><img src="images/arrow.png" border="0" alt="" />&nbsp;<b>Module&#39;s Name:</b></td><td>' . $mod_name . '</td></tr>';
	}
	if ($module_version != '') {
		echo '<tr><td nowrap="nowrap"><img src="images/arrow.png" border="0" alt="" />&nbsp;<b>Module&#39;s Version:</b></td><td>' . $module_version . '</td></tr>';
	}
	if ($release_date != '') {
		echo '<tr><td nowrap="nowrap"><img src="images/arrow.png" border="0" alt="" />&nbsp;<b>Release Date:</b></td><td>' . $release_date . '</td></tr>';
	}
	if ($mod_cost != '') {
		echo '<tr><td nowrap="nowrap"><img src="images/arrow.png" border="0" alt="" />&nbsp;<b>Module&#39;s Cost:</b></td><td>' . $mod_cost . '</td></tr>';
	}
	if ($license != '') {
		echo '<tr><td nowrap="nowrap"><img src="images/arrow.png" border="0" alt="" />&nbsp;<b>License:</b></td><td>' . $license . '</td></tr>';
	}
	if ($author_name != '') {
		echo '<tr><td nowrap="nowrap"><img src="images/arrow.png" border="0" alt="" />&nbsp;<b>Author&#39;s Name:</b></td><td>' . $author_name . '</td></tr>';
	}
	if ($author_email != '') {
		echo '<tr><td nowrap="nowrap"><img src="images/arrow.png" border="0" alt="" />&nbsp;<b>Author&#39;s Email:</b></td><td>' . $author_email . '</td></tr>';
	}
	if ($module_description != '') {
		echo '<tr><td nowrap="nowrap"><img src="images/arrow.png" border="0" alt="" />&nbsp;<b>Module&#39;s Description:</b></td><td>' . $module_description . '</td></tr>';
	}
	if ($download_location != '') {
		echo '<tr><td nowrap="nowrap"><img src="images/arrow.png" border="0" alt="" />&nbsp;<b>Module&#39;s Download:</b></td><td><a href="' . $download_location . '" target="_blank">Download</a></td></tr>';
	}
	echo '</table>';
	echo '<hr />';
