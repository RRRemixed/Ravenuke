...
$redirect = (isset($redirect)) ? html_entity_decode(check_html(trim($redirect) , 'nohtml')) : '';
...
switch ($op) {
	...
	case 'login':
		...
		$user_password = isset($user_password) ? htmlspecialchars(stripslashes($user_password)) : '';
