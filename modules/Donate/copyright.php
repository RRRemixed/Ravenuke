...
$module_description = "Donations Block w/ Donation Meter (IPN Integrated)";
...
if ($download_location == "") { echo"";} else { echo"<a href=\"$download_location\" target=\"new\">Module's Download</a> | ";
}
