...
echo '<center><h3>'.$lgl_lang['LGL_ADM_COM_MODTITLE'].'</h3>'.PHP_EOL;
echo '<b>'.$lgl_lang['LGL_ADM_DOCS_DBDELCONFIRM'].'</b><br /><br />'.PHP_EOL;
...
echo '&nbsp;&nbsp;|&nbsp;&nbsp;<a href="'.$admin_file.'.php?op=legal">'._NO.'</a></center>'.PHP_EOL;
