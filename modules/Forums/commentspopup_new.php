...
include("modules/".$module_name."/includes/functions_post.php");
...
include("modules/".$module_name."/includes/page_header_review.php");
...
if($mode == "update")
	{
			...
			if( !$result = $db->sql_query($sql) )
			{
	 		...
	 		header($header_location . append_sid("modules.php?name=Forums&file=gamespopup&gid=$game_id&mode=done", true));
                        exit;
...
include("modules/".$module_name."/includes/page_tail_review.php");
