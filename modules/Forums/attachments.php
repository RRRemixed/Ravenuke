 ...
 *
 *   $Id: attachments.php,v 1.0 2002/08/23 meik Exp $
 *
 *
 ***************************************************************************/
...
switch ($mode)
{
	...
	case 'post_time':
		...
		break;
	default:
		message_die(GENERAL_MESSAGE, "Please have a look at the attachments.php file and define valid default values.");
		break;
}
...
if ($sql != '')
{
	if ( !($result = ($sql_query) ? attach_sql_query($sql) : $db->sql_query($sql)) ) 
	{ 
