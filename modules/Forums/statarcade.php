...
$sql = "SELECT username, user_color_gc, user_avatar_type, user_allowavatar, user_avatar FROM " . USERS_TABLE . " WHERE user_id = " . $uid ;
...
$statuser = CheckUsernameColor($row['user_color_gc'], $row['username']);
