...
// -------------------------
//
function generate_user_info(&$row, $date_format, $group_mod, &$from, &$posts, &$joined, &$poster_avatar, &$profile_img, &$profile, &$search_img, &$search, &$pm_img, &$pm, &$email_img, &$email, &$www_img, &$www, &$fb_img, &$fb, &$tw_img, &$tw, &$skype_img, &$skype, &$steam_img, &$steam)
{
        ...
        $fb_img = ( $row['user_fb'] ) ? '<a href="' . $row['user_fb'] . '" target="_blank"><img src="' . $images['icon_fb'] . '" alt="' . $lang['Visit_fb'] . '" title="' . $lang['Visit_fb'] . '" border="0" /></a>' : '';
        $fb = ( $row['user_fb'] ) ? '<a href="' . $row['user_fb'] . '" target="_blank">' . $lang['Visit_fb'] . '</a>' : '';

        $tw_img = ( $row['user_tw'] ) ? '<a href="' . $row['user_tw'] . '" target="_blank"><img src="' . $images['icon_tw'] . '" alt="' . $lang['Visit_tw'] . '" title="' . $lang['Visit_tw'] . '" border="0" /></a>' : '';
        $tw = ( $row['user_tw'] ) ? '<a href="' . $row['user_tw'] . '" target="_blank">' . $lang['Visit_tw'] . '</a>' : '';

        $skype_img = ( $row['user_skype'] ) ? '<a href="' . $row['user_skype'] . '" target="_blank"><img src="' . $images['icon_skype'] . '" alt="' . $lang['Visit_skype'] . '" title="' . $lang['Visit_skype'] . '" border="0" /></a>' : '';
        $skype = ( $row['user_skype'] ) ? '<a href="' . $row['user_skype'] . '" target="_blank">' . $lang['Visit_skype'] . '</a>' : '';

        $steam_img = ( $row['user_steam'] ) ? '<a href="' . $row['user_steam'] . '" target="_blank"><img src="' . $images['icon_steam'] . '" alt="' . $lang['Visit_steam'] . '" title="' . $lang['Visit_steam'] . '" border="0" /></a>' : '';
        $steam = ( $row['user_steam'] ) ? '<a href="' . $row['user_steam'] . '" target="_blank">' . $lang['Visit_steam'] . '</a>' : '';
...
else if ( $group_id )
{
        ...
        //
        $sql = "SELECT username, user_id, user_color_gc, user_viewemail, user_posts, user_regdate, user_from, user_website, user_email, user_fb, user_tw, user_skype, user_steam
                FROM " . USERS_TABLE . "
        ...
        //
        $sql = "SELECT u.username, u.user_id, u.user_color_gc, u.user_viewemail, u.user_posts, u.user_regdate, u.user_from, u.user_website, u.user_email, u.user_fb, u.user_tw, u.user_skype, u.user_steam, ug.user_pending
        ...
        $sql = "SELECT u.username, u.user_id, u.user_color_gc, u.user_viewemail, u.user_posts, u.user_regdate, u.user_from, u.user_website, u.user_email, u.user_fb, u.user_tw, u.user_skype, u.user_steam
...
#====
	...
	// Add the moderator
	//
	$username = CheckUsernameColor($group_moderator['user_color_gc'], $group_moderator['username']);
#====
...
#======================================================================= |
        ...
        generate_user_info($group_moderator, $board_config['default_dateformat'], $is_moderator, $from, $posts, $joined, $poster_avatar, $profile_img, $profile, $search_img, $search, $pm_img, $pm, $email_img, $email, $www_img, $www, $fb_img, $fb, $tw_img, $tw, $skype_img, $skype, $steam_img, $steam);
        ...
        $template->assign_vars(array(
                ...
                'MOD_TW_IMG' => $tw_img,
                'MOD_TW' => $tw,
                'MOD_SKYPE_IMG' => $skype_img,
                'MOD_SKYPE' => $skype,
                'MOD_STEAM_IMG' => $steam_img,
                'MOD_STEAM' => $steam,
...
#====
	...
	{
		$username = CheckUsernameColor($group_members[$i]['user_color_gc'], $group_members[$i]['username']);
#====
#==== Author: aUsTiN [austin@phpbb-amod.com] [http://phpbb-tweaks.com] = |
#==== End: ==== Advanced Username Color ================================ |	
#======================================================================= |
                ...
                generate_user_info($group_members[$i], $board_config['default_dateformat'], $is_moderator, $from, $posts, $joined, $poster_avatar, $profile_img, $profile, $search_img, $search, $pm_img, $pm, $email_img, $email, $www_img, $www, $fb_img, $fb, $tw_img, $tw, $skype_img, $skype, $steam_img, $steam);
...
#==== v1.0.5 =========================================================== |
#====
				$username = CheckUsernameColor($modgroup_pending_list[$i]['user_color_gc'], $modgroup_pending_list[$i]['username']);
#====
#==== Author: aUsTiN [austin@phpbb-amod.com] [http://phpbb-tweaks.com] = |
#==== End: ==== Advanced Username Color ================================ |	
#======================================================================= |
                                ...
                                generate_user_info($modgroup_pending_list[$i], $board_config['default_dateformat'], $is_moderator, $from, $posts, $joined, $poster_avatar, $profile_img, $profile, $search_img, $search, $pm_img, $pm, $email_img, $email, $www_img, $www, $fb_img, $fb, $tw_img, $tw, $skype_img, $skype, $steam_img, $steam);
