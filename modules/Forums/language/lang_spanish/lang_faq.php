...
$faq[] = array("¿Por qué no puedo identificarme?", "¿Se ha registrado? Debe registrarse para poder identificarse. ¿Ha sido Ud. inhibido del foro? (Se le mostrará un mensaje si así es.) De ser así, debe contactar con el administrador para averiguar el porqué. Si se ha registrado y no ha sido inhibido y aún así no puede identificarse entonces vuelva a verificar su nombre de usuario y contraseña. Normalmente éste es el problema; si no, contacte con el administrador -- puede llegar a haber una configuración incorrecta del foro.");
...
$faq[] = array("¿Por qué me desconecta automáticamente?", "Si no activa la opción <i>Identificarme automáticamente</i>, el foro solo lo mantendrá identificado por un determinado tiempo. Esto previene el uso de su cuenta por otras personas. Para mantenerse identificado, active la opción al momento de identificarse. No se recomienda hacer esto si Ud. accede desde un ordenador compartido, por ej. cyber-café, trabajo, universidad, etc.");
$faq[] = array("¿Cómo evito que mi nombre de usuario aparezca en las listas de usuarios conectados?", "En su perfil encontrará una opción de <i>Ocultar mi estado de conexión</i>; si activa esta opción solo podrá ser visto por administradores y Ud. mismo. Se le contará como usuario oculto.");
$faq[] = array("¡Perdí mi contraseña!", "¡No se altere! Si bien su contraseña no se le puede enviar puede ser cambiada. Para esto vaya a Conectarse y pulse en <u>¡He olvidado mi contraseña!</u>. Siga las instrucciones y podrá volver a identificarse casi de inmediato.");
$faq[] = array("¡Me registré pero no puedo identificarme!", "Primero verifique que está ingresando el nombre de usuario y contraseña correctos. Si están bien entonces verifique estas posibilidades: si está habilitado el soporte para COPPA y Ud. pulsó en <u>tengo menos de 13 años</u> mientras se registraba entonces deberá seguir las instrucciones que recibió. Si este no es el caso, entonces su cuenta debe necesitar activación. Revise su correo y vea las instrucciones de activación, algunos foros dejan que sus usuarios activen sus cuentas y otros requieren la activación por parte del administrador. Si no recibió un correo, verifique que su correo sea correcto. Una de las razones por las que se pide activación es para evitar que usuarios anónimos abusen del foro. Si ninguna de estas descripciones concuerda con su problema, contacte con el administrador del foro.");
$faq[] = array("¡Me registré hace tiempo pero ya no puedo identificarme!", "Lo más probable es que: haya ingresado un nombre de usuario o contraseña incorrectos (verifique su correo, cuando se registró se le envió un mensaje con su nombre de usuario y contraseña) o el administrador ha borrado su cuenta por alguna razón. Es normal que los foros, periódicamente, \"limpien\" sus bases de datos de usuarios, si Ud. pasó mucho tiempo sin escribir mensajes nuevos, puede que éste sea el caso. Intente registrándose de nuevo.");
...
$faq[] = array("¿Cómo cambio mi rango?", "Por lo general no puede cambiar su Rango ya que éste es asociado directamente con el número de mensajes ingresados o se utilizan para identificar a ciertos usuarios (administrador, moderador o Rangos especiales). Por favor, no abuse del foro creando mensajes innecesarios solo para incrementar su Rango, no hay ningún beneficio adicional por tener Rangos.");
$faq[] = array("Cuando pulso en el enlace para enviar un correo a un usuario me pide nombre de usuario y contraseña.", "Disculpe, pero solo los usuarios registrados pueden enviar correos a través del foro (si el administrador ha habilitado esta opción). Esto es para evitar SPAM o mensajes maliciosos de usuarios anónimos.");
...
$faq[] = array("¿Cómo modifico o borro una encuesta?", "Al igual que con los mensajes, solo puede modificar o borrar una encuesta generada por Ud. (o siendo administrador o moderador). Para modificar una encuesta, pulse en el primer mensaje de un tema, que siempre es el que tiene la encuesta asociada. Si no se han realizado votaciones, se pueden modificar las opciones o borrarlas. Sin embargo, si ya existen votos, solo los administradores y moderadores pueden modificar la encuesta. Esto es para prevenir la falsificación de resultados de una encuesta por medio de la edición de la misma a mitad de camino.");
$faq[] = array("¿Por qué no puedo acceder a ciertos Foros?", "Algunos foros están limitados a ciertos usuarios o grupos de usuarios. Para verlos, crear mensajes, modificar, etc. necesita ciertas autorizaciones que solo te puede dar un moderador o administrador del foro.");
$faq[] = array("¿Por qué no puedo votar en encuestas?", "solo usuarios registrados pueden votar en las encuestas (para prevenir resultados falseados). Si se ha registrado pero no puede votar, es posible que no tenga autorización para votar en esa encuesta.");
...
$faq[] = array("¡No puedo enviar Mensajes Privados!", "Hay tres posibles razones: No está registrado y/o no se ha identificado, el administrador deshabilitó el sistema de mensajes privados o el administrador ha deshabilitado la mensajería privada para Ud. Si éste es el caso, trate de contactar con el administrador y pregúntele el motivo.");
