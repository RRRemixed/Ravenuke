...
$lang['Server_port_explain'] = 'El puerto en el que funciona el servidor, generalmente 80. Cámbielo solo si es diferente';
$lang['Site_name'] = 'Nombre del Sitio';
$lang['Site_desc'] = 'Descripción del Sitio';
$lang['Board_disable'] = 'Desactivar foro';
$lang['Board_disable_explain'] = 'Esto hará que el foro no esté disponible a los usuarios. NO desconecte su nombre de usuario mientras el foro esté desactivado o no podrá identificarse de nuevo. Los Administradores pueden acceder el Panel de Administración mientras el foro está deshabilitado.';
...
$lang['Allow_autologin_explain'] = 'Determina que a los usuarios se les permitirá elegir si quieren ser identificados automáticamente en el foro.';
...
$lang['User_special'] = 'Campos solo para administración';
...
$lang['Theme_info_saved'] = 'La información de estilo para la plantilla seleccionada ha sido guardada. Debería volver los permisos sobre la carpeta del estilo y el theme_info.cfg a solo Lectura';
...
$lang['Re_install'] = 'Su instalación previa está todavía activa.<br /><br />Si quiere reinstalar phpBB 2 debería pulsar en el botón "Sí". Por favor, sepa que haciéndolo se perderá toda la información y ¡no se hará copia de seguridad (backup)! El nombre y clave de Administrador que ha usado para identificarse al foro serán creados de nuevo después de reinstalar y no se conservarán otras configuraciones.<br /><br />¡Piense cuidadosamente antes de decir que "Sí"!';
...
$lang['Unwriteable_config'] = 'Su configuración no se puede salvar en este momento (seguramente porque ha mantenido los derechos del archivo config.php como "solo Lectura"). Una copia de la configuración será descargada a su disco duro cuando pulse en el enlace de abajo. Debería subir este archivo al mismo directorio raiz del phpBB 2. Una vez hecho esto debería identificarse usando su nombre y contraseña de Administrador y acceder al Panel de Configuración (un enlace aparecerá a pie de página una vez que se identifique) para verificar la Configuración General. Gracias por elegir phpBB 2.';
...
//
$lang['Max_login_attempts'] = 'Intentos de identificación permitidos';
$lang['Max_login_attempts_explain'] = 'El numero de intentos de identificación permitido en su Foro.';
$lang['Login_reset_time'] = 'Tiempo de identificación cerrada';
$lang['Login_reset_time_explain'] = 'Tiempo en minutos que el usuario tiene que esperar hasta que se le permita de nuevo la identificación después de exceder el número de intentos permitidos de conexión o identificación.';
