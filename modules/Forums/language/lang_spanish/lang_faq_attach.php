...
$faq[] = array("¿Como agrego un adjunto?", "Puede agregar un adjunto cuando envie un nuevo post. Deberia ver el formulario <i>Agregar un Adjunto</i> debajo del cuadro de texto del mensaje. Cuando haga click en el boton <i>Buscar...</i> se abrira la ventana de dialogo para buscar en su computadora. Busque el archivo que quiere adjuntar, marquelo y haga click en OK, Open o doble click segun el procedimiento correcto para su computadora. Si desea hacer un comentario en el campo <i>Comentario</i> este comentario sera usado como un link al archivo adjuntado. Si no agrego un comentario se usara el nombre del archivo. Si el administrador lo permite usted podra adjuntar varios archivos mediante el mismo procedimiento hasta alcanzar el numero maximo de adjuntos permitidos para cada post.<br/><br/>El administrador fija un tamaño maximo para los archivos, define las extensiones permitidas para los archivos y otras cosas relacionadas con el foro. Atencion, es su responsabilidad cumplir con las normas fijadas en la politica del foro, pueden ser borrados sin aviso.<br/><br/>Por favor tome nota, los dueños, webmaster, administradores y moderadores del foro no pueden y no se haran responsables por la perdida de datos.");

$faq[] = array("¿Como agrego un adjunto despues de enviar un mensaje?", "Para agregar un adjunto despues de haber enviado el mensaje, debera editar el mismo y seguir los procedimientos antes descriptos. Los nuevos adjuntos seran agregados cuando haga click en <i>Enviar</i> para enviar el post editado.");

$faq[] = array("¿Como borro un adjunto?", "Para borrar un adjunto debera editar el post y hacer click en <i>Borrar Adjunto</i> junto al adjunto que quiere borrar en el cuadro <i>Adjuntos Enviados</i> . Los nuevos adjuntos seran borrados cuando haga click en <i>Enviar</i> para enviar el post editado.");

$faq[] = array("¿Como actualizo el comentario de un adjunto?", "Para actualizar el comentario de un adjunto debera editar el post, edite el texto en el campo <i>Comentario</i> y haga click en el boton <i>Actualizar Comentario</i> . Los nuevos comentarios seran actualizados cuando haga click en <i>Enviar</i> para enviar el post editado.");
