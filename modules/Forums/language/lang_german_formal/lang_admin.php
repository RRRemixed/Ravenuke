...
$lang['Backup'] = 'Backup';
$lang['Restore_explain'] = 'Hiermit werden alle phpBB Tabellen aus einer Datei wiederhergestellt. Falls es Ihr Server unterstützt, können Sie auch einen GZip-komprimierten Text hochladen - er wird automatisch dekomprimiert! <b>ACHTUNG</b>: Es werden alle existierenden Daten überschrieben. Der Vorgang wird einige Zeit dauern, bitte verlassen Sie diese Seite nicht, bis er abgeschlossen wurde.';
$lang['Backup_explain'] = 'Hier können Sie alle phpBB-Tabellen abspeichern. Sollten Sie noch weitere, eigene Tabellen in derselben Datenbank wie die phpBB-Tabellen haben, die auch gespeichert werden sollen, geben Sie ihre Namen in der \'Zusätzliche Tabellen\'-Textbox an (getrennt mit Kommata). Sollte Ihr Server es unterstützen, können Sie die Datei(en) auch mit GZip komprimieren, bevor Sie sie runterladen.';
...
$lang['Group_auth_explain'] = 'Sie können hier die Befugnisse und den Moderator-Status für jede Gruppe einstellen. Vergessen Sie nicht, dass einzelne Benutzerbefugnisse immer noch gültig sind, wenn Sie die Gruppenbefugnisse ändern (z. B. Zugang zu Foren u. ä.). Sollte dies der Fall sein, werden Sie darüber informiert.';
$lang['User_auth_explain'] = 'Sie können hier die Befugnisse und den Moderator-Status für jeden einzelnen Benutzer einstellen. Vergessen Sie nicht, dass Gruppenbefugnisse immer noch gültig sind, wenn Sie die Benutzerbefugnisse ändern (z. B. Zugang zu Foren u. ä.). Sollte dies der Fall sein, werden Sie darüber informiert.';
...
$lang['Conflict_access_groupauth'] = 'Der oder die folgenden Benutzer haben auf Grund ihrer Benutzereinstellungen immer noch das Zugangsrecht zu diesem Forum. Vielleicht sollten Sie diese Einstellungen ändern, um dem Benutzer komplett den Zugang zu verweigern. Die Benutzer mit Rechten (und die dazugehörigen Foren) stehen unten.';
$lang['Conflict_mod_groupauth'] = 'Der oder die folgenden Benutzer haben auf Grund ihrer Benutzereinstellungen immer noch Moderatorenrechte in diesem Forum. Vielleicht sollten Sie diese Einstellungen ändern, um dem Benutzer komplett die Rechte zu nehmen. Die Benutzer mit Rechten (und die dazugehörigen Foren) stehen unten.';
...
$lang['Click_return_userauth'] = 'Klicken Sie %shier%s, um zu den Benutzerrechten zurückzukehren';
$lang['Click_return_groupauth'] = 'Klicken Sie %shier%s, um zu den Gruppenrechten zurückzukehren';
$lang['Click_return_forumauth'] = 'Klicken Sie %shier%s, um zu den Forenberechtigungen zurückzukehren';
...
$lang['Ban_explain'] = 'Hier können Sie Benutzer bannen. Sie können entweder einen bestimmten Benutzer, eine IP-Adresse oder einen Hostnamen sperren. Durch diese Methode kann der Benutzer die Startseite des Forums nicht aufrufen. Um den Benutzer daran zu hindern, sich unter einem anderen Namen anzumelden, können Sie auch bestimmte E-Mail-Adressen sperren. Eine E-Mail-Sperre verhindert nur das Registrieren, nicht das Posten eines Benutzers!';
$lang['Ban_explain_warn'] = 'Bitte beachten Sie, dass, wenn Sie mehrere IP-Adressen eingeben, alle Adressen zwischen dem Anfang und dem Ende der Sperrliste hinzugefügt werden. Versuchen Sie die Anzahl der Adressen klein zu halten, indem Sie Wildcards einsetzen, wo es möglich ist. Am besten ist es, eine konkrete IP-Adresse anzugeben.';
...
$lang['Ban_username_explain'] = 'Wenn Sie mehrere Benutzer auswählen, können Sie auch mehrere Benutzer auf einmal bannen';
...
$lang['Ban_email_explain'] = 'Um mehrere verschiedene E-Mail Adressen anzugeben, trennen Sie sie mit Kommata voneinander. Für einen allgemeinen Benutzernamen benutzen Sie ein * (z.B. *@hotmail.de)';

$lang['Unban_username'] = 'Einen oder mehrere Benutzer entsperren';
$lang['Unban_username_explain'] = 'Wenn Sie mehrere Benutzer auswählen, können Sie auch mehrere Benutzer auf einmal entsperren';

$lang['Unban_IP'] = 'Eine oder mehrere IP-Adressen entsperren';
$lang['Unban_IP_explain'] = 'Wenn Sie mehrere IP-Adressen auswählen, können Sie auch mehrere IP-Adressen auf einmal entsperren';

$lang['Unban_email'] = 'Eine oder mehrere E-Mail Adressen entsperren';
$lang['Unban_email_explain'] = 'Wenn Sie mehrere E-Mail Adressen auswählen, können Sie auch mehrere E-Mail Adressen auf einmal entsperren';
...
$lang['Click_return_banadmin'] = 'Klicken Sie %shier%s, um zur Sperr-Kontrolle zurückzukehren';
...
$lang['Click_return_config'] = 'Klicken Sie %shier%s, um zur allgemeinen Konfiguration zurückzukehren';
...
$lang['Server_port_explain'] = 'Der Port, unter dem Ihr Server läuft, normalerweise 80. Ändern Sie dies nur, wenn es ein anderer Port ist';
$lang['Site_name'] = 'Name der Seite';
$lang['Site_desc'] = 'Beschreibung der Seite';
$lang['Board_disable'] = 'Board deaktivieren';
$lang['Board_disable_explain'] = 'Hiermit sperren Sie das Forum für alle Benutzer. Administratoren können auf den Administrations-Bereich zugreifen, wenn das Forum gesperrt ist.';
...
$lang['Use_SMTP_explain'] = 'Wählen Sie \'Ja\', wenn Sie möchten, dass Ihre E-Mails über einen SMTP-Server gesendet werden';
...
// Visual Confirmation
$lang['Visual_confirm'] = 'Visuelle Bestätigung aktivieren';
...
$lang['prune_freq'] = 'Das Themenalter überprüfen: Alle';
$lang['prune_days'] = 'Themen entfernen, in denen nichts mehr geschrieben wurde seit';
$lang['Set_prune_data'] = 'Sie haben das automatische Löschen für dieses Forum aktiviert, aber weder ein Intervall noch eine Anzahl an Tagen angegeben.';
...
$lang['Edit_Category_explain'] = 'Hier können Sie den Namen einer Kategorie ändern';
...
$lang['Click_return_forumadmin'] = 'Klicken Sie %shier%s, um zur Forumsadministration zurückzukehren';
...
$lang['Select_pak'] = 'Paketdatei wählen (.pak)';
$lang['replace_existing'] = 'Aktuelle Smilies überschreiben';
$lang['keep_existing'] = 'Aktuelle Smilies behalten';
$lang['smiley_import_inst'] = 'Sie sollten das Smilie-Paket entzippen und alle Dateien ins jeweilige Smilies-Verzeichnis hochladen. Wählen Sie dann die korrekten Angaben, um das Paket zu installieren.';
$lang['smiley_import'] = 'Smilie-Paketimport';
$lang['choose_smile_pak'] = 'Wählen Sie ein Smilie-Paket (.pak)';
...
$lang['User_admin_explain'] = 'Hier können Sie die Daten und Optionen eines Nutzers ändern. Um die Befugnisse eines Benutzers zu ändern, benutzen Sie bitte die Benutzer- und Gruppenkontrolle.';

$lang['Look_up_user'] = 'Benutzer auswählen';

$lang['Admin_user_fail'] = 'Benutzerprofil konnte nicht geändert werden';
$lang['Admin_user_updated'] = 'Benutzerprofil geändert';
$lang['Click_return_useradmin'] = 'Klicken Sie %shier%s, um zur Benutzeradministration zurückzukehren';
...
$lang['User_special_explain'] = 'Diese Optionen können nicht von den Benutzern geändert werden. Sie können hier den Status und andere Optionen der Benutzer festlegen, die den Benutzern selbst nicht zur Verfügung stehen.';
...
$lang['Group_admin_explain'] = 'Hier können Sie die Benutzergruppen Ihres Forums überwachen. Sie können bestehende Gruppen löschen oder editieren oder neue anlegen. Ebenso können Sie Gruppenleiter wählen, den Gruppenstatus auf offen/geschlossen ändern und den Gruppennamen bzw. die Gruppenbeschreibung ändern';
...
$lang['Click_return_groupsadmin'] = 'Klicken Sie %shier%s, um zur Gruppenadministration zurückzukehren.';
...
$lang['Words_explain'] = 'Hier können Sie Wörter bestimmen, die in den Beiträgen automatisch zensiert werden. Außerdem kann kein Benutzer einen Namen wählen, in dem diese Wörter vorkommen. Sie können ein * als Platzhalter im Wort-Feld verwenden. Beispiel: Fisch* entfernt Wörter wie Fischbesteck, Fischfang usw., *Fisch entfernt Backfisch, Stockfisch usw.';
$lang['Word'] = 'Wort';
...
// Mass Email
//
$lang['Mass_email_explain'] = 'Hier können Sie entweder allen registrierten Benutzern oder einer bestimmten Gruppe eine Nachricht schicken. Diese Nachricht wird an das Postfach des Administrators geschickt und anonym (BCC) an alle Empfänger. Sollten Sie einer großen Gruppe eine E-Mail schicken, haben Sie etwas Geduld und brechen Sie den Vorgang nicht ab. Es ist völlig normal, dass der Vorgang länger dauert und Sie erhalten eine Rückmeldung, wenn das Skript beendet ist';
...
$lang['Click_return_massemail'] = 'Klicken Sie %shier%s, um zur Massen E-Mail zurückzukehren';
...
$lang['Ranks_explain'] = 'Hier können Sie Ränge hinzufügen, editieren, anschauen und löschen. Sie können ebenfalls eigene Ränge erstellen, die Sie per Benutzeradministration an spezielle Benutzer vergeben.';
...
$lang['Disallow_explain'] = 'Hier können Sie Benutzernamen überwachen, die nicht genutzt werden dürfen. Sie können einen Stern (*) als Platzhalter setzen. Beachten Sie, dass Sie den jeweiligen Benutzer zuerst löschen müssen, wenn Sie einen bereits vergebenen Benutzernamen wählen.';

$lang['Delete_disallow'] = 'Löschen';
$lang['Delete_disallow_title'] = 'Einen verbotenen Namen entfernen';
$lang['Delete_disallow_explain'] = 'Sie können einen verbotenen Namen entfernen, indem Sie den Namen aus der Liste auswählen und Löschen anklicken';
...
$lang['Click_return_disallowadmin'] = 'Klicken Sie %shier%s, um zum Verbot der Benutzernamen zurückzukehren';
...
$lang['Theme_info_saved'] = 'Die Themeinformationen für das gewählte Template wurden gespeichert. Sie sollten jetzt die Dateizugriffsrechte der theme_info.cfg (und eventueller Verzeichnisse) auf Nur-Lesen zurück stellen';
$lang['Theme_updated'] = 'Das gewählte Theme wurde aktualisiert. Sie sollten die neuen Themeeinstellungen jetzt exportieren.';
$lang['Theme_created'] = 'Theme erstellt. Sie sollten das Theme jetzt in die Themekonfiguration exportieren, damit es nicht verloren geht oder Sie es an anderer Stelle einsetzen können.';

$lang['Confirm_delete_style'] = 'Diesen Style wirklich löschen?';

$lang['Download_theme_cfg'] = 'Der Exporter konnte nicht in die Themeinformationsdatei schreiben. Klicken Sie auf den unteren Knopf, um die Datei per Browser runterzuladen. Haben Sie sie runtergeladen, können Sie die Datei in Ihren Ordner mit den Templatedateien kopieren. Schließlich können Sie die Dateien zu einem Paket zusammenschließen.';
...
$lang['Click_return_styleadmin'] = 'Klicken Sie %shier%s, um zur Styles Administration zurückzukehren';
...
$lang['continue_upgrade'] = 'Sobald Sie die Konfigurationsdatei auf Ihren Rechner heruntergeladen haben, können Sie die Schaltfläche \'Upgrade fortsetzen\' betätigen, um mit dem Upgrade-Prozess fortzufahren. Bitte warten Sie mit dem Hochladen der Konfigurationsdatei, bis der Upgrade-Prozess beendet ist.';
...
$lang['Re_install'] = 'Ihre vorherige Installation ist noch aktiv.<br /><br />Falls Sie phpBB2 neu installieren möchten, aktivieren Sie den unten stehenden Ja-Knopf. Beachten Sie jedoch, dass dieser Vorgang sämtliche existierenden Daten zerstören wird und keine Sicherungen vorgenommen werden. Der Administrator-Benutzername und das Passwort, das Sie benutzt haben, um sich im Board einzuloggen, werden nach der Neuinstallation erneut erstellt. Es bleiben sonst keine Einstellungen zurück.<br /><br />Überlegen Sie es sich gut, bevor Sie auf Ja klicken.';

$lang['Inst_Step_0'] = 'Danke, dass Sie sich für phpBB 2 entschieden haben. Um die Installation abzuschließen, geben Sie bitte die unten geforderten Daten ein. Beachten Sie, dass die Datenbank, in welche Sie installieren, bereits vorhanden sein sollte. Sollten Sie in eine Datenbank installieren, die ODBC nutzt, z. B. MS Access, sollten Sie erst einen DSN für sie erstellen, bevor Sie fortfahren.';
...
$lang['Install_lang'] = 'Sprache für die Installation wählen';
...
$lang['Inst_Step_2'] = 'Ihr Administrator-Benutzername wurde erstellt. Ihre Installation ist nun komplett. Sie werden jetzt auf eine Seite geführt, wo Sie ihr neues Board Ihren Bedürfnissen anpassen können. Überprüfen Sie am besten gleich die allgemeine Konfiguration und nehmen Sie eventuell nötige Änderungen vor. Danke, dass Sie sich für phpBB 2 entschieden haben.';

$lang['Unwriteable_config'] = 'Momentan ist Ihre Konfigurationsdatei nicht beschreibbar. Sie können sich eine Kopie der Datei runterladen, wenn Sie auf den entsprechenden Link unten klicken. Sie sollten diese Datei ins selbe Verzeichnis wie phpBB2 hochladen. Wenn dies getan ist, sollten Sie sich mit Ihrem Administrator-Benutzernamen und Passwort, die Sie auf der letzten Seite angegeben haben, einloggen und den Administrationsbereich betreten, um die allgemeinen Einstellungen zu prüfen. Einen entsprechenden Link finden Sie am Ende jeder Seite Ihres Forums. Danke, dass Sie sich für phpBB 2 entschieden haben.';
$lang['Download_config'] = 'Konfigurationsdatei herunterladen';

$lang['ftp_choose'] = 'Downloadmethode wählen';
$lang['ftp_option'] = '<br />Da FTP Erweiterungen in dieser Version von PHP aktiviert sind, könnten Sie die Möglichkeit haben, die Konfigurationsdatei automatisch per FTP vor Ort zu ändern.';
...
$lang['Install_Method'] = 'Wählen Sie eine Installations-Methode aus';

$lang['Install_No_Ext'] = 'Die PHP-Konfiguration auf Ihrem Server unterstützt nicht den gewählten Datenbank-Typ';

$lang['Install_No_PCRE'] = 'phpBB 2 benötigt das Perl-Compatible Regular Expressions Module für PHP, was von Ihrer PHP-Konfiguration anscheinend nicht unterstützt wird.';

//
// Version Check
//
$lang['Version_up_to_date'] = 'Ihr Forum ist auf dem neuesten Stand; es sind keine Updates für Ihre phpBB-Version verfügbar.';
$lang['Version_not_up_to_date'] = 'Ihr Forum ist wahrscheinlich <b>nicht</b> auf dem neuesten Stand. Es sind Updates für Ihre phpBB-Version verfügbar, bitte besuchen Sie <a href="http://www.phpbb.com/downloads.php" target="_blank">http://www.phpbb.com/downloads.php</a>, um die aktuellste Version zu erhalten.';
...
$lang['Mailing_list_subscribe_reminder'] = 'Um immer die neuesten Informationen zu Updates von phpBB zu erhalten, sollten Sie sich <a href="http://www.phpbb.com/support/" target="_blank">beim phpBB Newsletter anmelden</a>.';
