...
/**************************************************************************/
/*  A magyar fordítást a PHP-Nuke Magyarország csapata készítette.        */
...
$faq[] = array("Hogyan változtathatom meg a beállításaimat?", "Amennyiben regisztrált felhasználó vagy, a beállításaidat a <u>Profil</u> menüpontra kattintva érheted el. Ez általában az oldal tetején található, de nem minden esetben - függ a használatban lévõ sablontól.");
...
$faq[] = array("Hogyan csatlakozhatok egy Csoporthoz?", "A Csoportok megtekintéséhez kattints a lap tetején található Csoportok menüpontra. A link helye a használt sablontól függ. Nem minden csoport érhetõ el, lehetnek <i>nyílt</i> csoportok, zárt csoportok, vagy akár rejtett csoportok is. Ha csoport nyitott, akkor a megfelelõ gombra kattintva el lehet küldeni a csatlakozási kérelmet. A csatlakozáshoz szükséges a csoport Moderátorának jóváhagyása, megkérdezheti, hogy miért takarsz csatlakozni a csoportba. Ha a moderátor elutasítja a kérelmedet, akkor annak biztosan megvan az oka, így ne õt hibáztasd.");
