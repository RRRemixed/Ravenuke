 ...
 *     version         : 2.0.18
 *     edited by       : Fodor Bertalan - http://www.phpbb.hu
 *
 ****************************************************************************/ 
...
$faq[] = array("--","Bevezetõ");
$faq[] = array("Mi az a BBCode?", "A BBCode egy speciális változata a HTML nyelvnek. A BBCode használatának engedélyezése a fórum Adminisztrátorától függ, de Önnek is lehetõsége van arra, hogy a hozzászólásaiban ki-, vagy bekapcsolja a BBCode-ot. A BBCode hasonló felépítésû, mint a HTML, kivéve hogy a tagek nem kacsacsõrök között (&lt; és &gt;), hanem szögletes zárójelben \"[\" \"]\" vannak;  amellett  lehetõséget nyújt a szövegeket szebben, jobban, tagoltabban megjeleníteni. A használatban lévõ sablontól függ, hogy pontosan hol található a BBCode panel, melyrõl könnyedén és gyorsan be lehet illeszteni a tageket a szövegbe. Fontos, hogy mindig ügyeljünk a tagek lezárására. Az alábbiakban egy rövid bemutató található a BBCode lehetõségeirõl.<br />");
...
$faq[] = array("Használhatok egyszerre többféle formázást?", "Igen, természetesen ezeket lehet kombinálni; például ha fel akarja hívni valakinek a figyelmét a szövegre:<br /><br />Az <b>[size=18][color=red][b]</b>OLVASSA EL!<b>[/b][/color][/size]</b><br /><br /> kombináció ezt eredményezi: <span style=\"color:red;font-size:18px\"><b>OLVASSA EL!</b></span><br /><br />Nem ajánlatos egyszerre sok ilyet használni, mert a szöveg nehezen lesz olvasható. Emlékeztetõül, mindig figyeljen a tagek sorrendjére. A következõ példa hibás:<br /><br /><b>[b][u]</b>Ez így hibás<b>[/b][/u]</b><br />");
