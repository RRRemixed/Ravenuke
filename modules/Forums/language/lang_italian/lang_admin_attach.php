...
$lang['Attach_settings'] = 'RavenNuke &trade; Attachment Settings';
...
$lang['Upload_directory_explain'] = 'Enter the relative path from your RavenNuke installation to the Attachments upload directory. For example, enter \'modules/Forums/files\' if your RavenNuke Installation is located at http://www.yourdomain.com/ and the Attachment Upload Directory is located at http://www.yourdomain.com/modules/Forums/files.';
...
$lang['Ftp_download_path_explain'] = 'Enter the URL to your FTP Path, where your Attachments are stored.<br />If you are using a Remote FTP Server, please enter the complete url, for example http://www.mywebsite.com/modules/Forums/files.<br />If you are using your Local Host to store your Files, you are able to enter the url path relative to your RavenNuke Directory, for example \'upload\'.<br />A trailing slash will be removed. Leave this field empty, if the FTP Path is not accessible from the Internet. With this field empty you are unable to use the physical download method.';
...
$lang['No_ftp_extensions_installed'] = 'You are not able to use the FTP Upload Methods, because FTP Extensions are not compiled into your servers PHP Installation.';
