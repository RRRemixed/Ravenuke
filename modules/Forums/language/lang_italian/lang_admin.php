...
$lang['Create_theme_explain'] = 'Utilizza il modulo qui sotto per creare un unovo tema per il modello selezionato. Quando inserisci i colori (devi usare la notazione esadecimale) non  devi includere all\'inizio #, es. CCCCCC è valido, #CCCCCC non valido.';
