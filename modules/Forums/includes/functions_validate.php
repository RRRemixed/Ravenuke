...
//
function validate_optional_fields(&$website, &$fb, &$tw, &$steam, &$location, &$occupation, &$interests, &$sig)
{
        $check_var_length = array('website', 'fb', 'tw', 'steam', 'location', 'occupation', 'interests', 'sig');
