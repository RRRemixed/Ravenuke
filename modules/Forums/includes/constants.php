...
// Jail
define('JAIL_USERS_TABLE', $prefix.'_bbjail_users'); 
define('JAIL_VOTES_TABLE', $prefix.'_bbjail_votes');
// Welcom PM
define('WPM', $prefix.'_bbwpm');
// Start add - Complete banner MOD
...
// FLAGHACK-start
define('FLAG_TABLE', $prefix.'_flags'); 
// FLAGHACK-end fixed 2-17-2005 Steve DeMarcus (fixes admin control panel in forums)
define('MYCALENDAR_TABLE', $user_prefix.'_bbmycalendar');
// End add - Complete banner MOD
?>
