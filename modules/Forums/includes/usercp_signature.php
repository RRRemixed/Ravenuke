...
include('modules/Forums/includes/bbcode.'.$phpEx);
include('modules/Forums/includes/functions_post.'.$phpEx);
include('modules/Forums/includes/page_header.'.$phpEx);
...
// template
	...
	$template->assign_vars(array( 
		...
		'FB_IMG'    => '<img src="' . $images['icon_fb'] . '" alt="' . $lang['FB'] . '" title="' . $lang['FB'] . '" border="0" />',
		'TW_IMG'    => '<img src="' . $images['icon_tw'] . '" alt="' . $lang['TW'] . '" title="' . $lang['TW'] . '" border="0" />',
		'SKYPE_IMG'    => '<img src="' . $images['icon_skype'] . '" alt="' . $lang['SKYPE'] . '" title="' . $lang['SKYPE'] . '" border="0" />',
		'STEAM_IMG'    => '<img src="' . $images['icon_steam'] . '" alt="' . $lang['STEAM'] . '" title="' . $lang['STEAM'] . '" border="0" />',
