...
#==== v1.0.5 =========================================================== |
#====
				$poster .= ( $searchset[$i]['user_id'] != ANONYMOUS ) ? CheckUsernameColor($searchset[$i]['user_color_gc'], $searchset[$i]['username']) : ( ( CheckUsernameColor($searchset[$i]['user_color_gc'], $searchset[$i]['post_username']) != "" ) ? CheckUsernameColor($searchset[$i]['user_color_gc'], $searchset[$i]['post_username']) : $lang['Guest'] );
#====
