...
$module_name = "Forums";
//define('RN_MODULE_CSS', 'Forums.css');    // RN0000391
...
// 0001676: header.php should load default css file for the default forum template
$ForumThemeSel = get_theme();
$ForumCssFile = INCLUDE_PATH . 'themes/' . $ForumThemeSel . '/style/Forums.css';
if (file_exists($ForumCssFile)) {
	define('RN_MODULE_CSS', 'Forums.css');
}else{
	$ForumCssFile = INCLUDE_PATH . 'themes/' . $ForumThemeSel . '/forums';
	if (!file_exists($ForumCssFile)) {
		$ForumCssFile = INCLUDE_PATH . 'modules/Forums/templates/subSilver/subSilver.css';
		addCSSToHead($ForumCssFile, 'file');
	}
}
// end 0001676
