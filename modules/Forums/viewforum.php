...
// for this forum
//
$sql = "SELECT t.*, u.username,  u.user_color_gc, u.user_id, u2.username as user2, u2.user_color_gc as color2, u2.user_id as id2, p.post_username, p2.post_username AS post_username2, p2.post_time
...
#====
		...
		$topic_rowset[$i]['user2']		= CheckUsernameColor($topic_rowset[$i]['color2'], $topic_rowset[$i]['user2']);
#====
#==== Author: aUsTiN [austin@phpbb-amod.com] [http://phpbb-tweaks.com] = |
#==== End: ==== Advanced Username Color ================================ |	
#======================================================================= |
