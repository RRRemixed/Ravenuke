	...
	if ($mode == 'editprofile') {
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$("input[name=\"username\"],input[name=\"email\"],input[name=\"cur_password\"],input[name=\"new_password\"],input[name=\"password_confirm\"],input[name=\"confirm_code\"],input[name=\"website\"],input[name=\"fb\"],input[name=\"tw\"],input[name=\"skype\"],input[name=\"steam\"],input[name=\"location\"],input[name=\"occupation\"],input[name=\"interests\"],input[name=\"gender\"],input[name=\"dateformat\"]").attr("readonly", true);
