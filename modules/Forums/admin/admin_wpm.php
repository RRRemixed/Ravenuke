...
if( !empty($setmodules) )
{
	...
	$module['Forum_W']['PM_Settings'] = $filename;
	return;
}
...
$template->assign_vars(array(
	...
	'WPM_ACTIVE_YES' => ( $board_config['active_wpm'] ? 'CHECKED' : '' ),
	'WPM_ACTIVE_NO' => ( !$board_config['active_wpm'] ? 'CHECKED' : '' ),	
	'WPM_SUBJECT' => $wpm_config['wpm_subject'],
	'WPM_MESSAGE' => $wpm_config['wpm_message'],
