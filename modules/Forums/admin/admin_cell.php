...
$template->set_filenames(array(
	'body' => 'admin/config_cell_body.tpl')
);
...
{
	$user1 = ($HTTP_POST_VARS['from'] == 'list') ? TRUE : FALSE;
}
else if(isset($HTTP_GET_VARS['from']))
{
	$user1 = ($HTTP_GET_VARS['from'] == 'list') ? TRUE : FALSE;
}
...
{
	$template->set_filenames(array(
		'body' => 'admin/config_cell_users_body.tpl')
	);
...
else if( $user_update )
{
	...
	$tsql = "SELECT * FROM " . JAIL_USERS_TABLE . "
...
$template->assign_vars(array(
	...
	"S_SUBMIT_ACTION" => append_sid("admin_cell.php"),
));
