...
<script language="Javascript" src="modules/Forums/js/mycalendar.js"></script>
...
<tr align="center">
<td colspan="{S_SMILIES_COLSPAN}" class="nav"><a href="{U_MORE_SMILIES}" onclick="window.open('{U_MORE_SMILIES}', 'phpbbsmilies', 'HEIGHT=250,resizable=yes,scrollbars=yes,WIDTH=300');return false;" target="phpbbsmilies">{L_MORE_SMILIES}</a></td>
</tr>
...
<tr>
<td colspan="9">
<textarea name="message" rows="15" cols="35" style="width:450px;height:250px;" tabindex="3" class="post" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);">{MESSAGE}</textarea>
</td>
</tr>
</table>
</td>
