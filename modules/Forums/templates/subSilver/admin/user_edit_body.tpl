...
<form action="{S_PROFILE_ACTION}" {S_FORM_ENCTYPE} method="post"><table width="98%" cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	...
	<tr> 
	  <td class="row1"><span class="gen">{L_FB}</span></td>
	  <td class="row2"> 
		<input class="post" type="text" name="fb" size="15" maxlength="255" value="{FB}" />
	  </td>
	</tr>
	<tr> 
	  <td class="row1"><span class="gen">{L_TW}</span></td>
	  <td class="row2"> 
		<input class="post" type="text" name="tw" size="15" maxlength="255" value="{TW}" />
	  </td>
	</tr>
	<tr> 
	  <td class="row1"><span class="gen">{L_SKYPE}</span></td>
	  <td class="row2"> 
		<input class="post" type="text" name="skype" size="15" maxlength="255" value="{SKYPE}" />
	  </td>
	</tr>
	<tr> 
	  <td class="row1"><span class="gen">{L_STEAM}</span></td>
	  <td class="row2"> 
		<input class="post" type="text" name="steam" size="15" maxlength="255" value="{STEAM}" />
	  </td>
	</tr>
	<tr> 
