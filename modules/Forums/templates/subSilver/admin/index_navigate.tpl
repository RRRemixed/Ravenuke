...
<table width="100%" cellpadding="4" cellspacing="0" border="0" align="center">
  <tr>
	<td align="center" ><a href="../../../{U_FORUM_INDEX}" target="_parent"><img src="../templates/subSilver/images/logo_phpBB_med.gif" border="0" alt="" /></a></td>
  </tr>
  <tr>
	<td align="center" >
	  <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
		...
		<tr>
		  <td class="row1"><span class="genmed"><a href="../../../{U_FORUM_PREINDEX}" target="main" class="genmed">{L_PREVIEW_FORUM}</a></span></td>
		</tr>
		<!-- BEGIN catrow -->
		<tr>
