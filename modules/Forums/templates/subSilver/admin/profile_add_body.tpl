...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<tr> 
	  ...
	  <td class="row2"> 
		<input type="text" name="fb" class="post" style="width: 100px"  size="20" maxlength="255" value="{FB}" />
	  </td>
	</tr>
	<tr> 
	  <td class="row1"><span class="gen">{L_TW}:</span></td>
	  <td class="row2"> 
		<input type="text" class="post" style="width: 100px"  name="tw" size="20" maxlength="255" value="{TW}" />
	  </td>
	</tr>
	<tr> 
	  <td class="row1"><span class="gen">{L_STEAM}:</span></td>
	  <td class="row2"> 
		<input type="text" class="post" style="width: 100px"  name="steam" size="20" maxlength="255" value="{STEAM}" />
	  </td>
	</tr>
	<tr> 
