...
<table class="forumline" cellpadding="4" cellspacing="1" border="0" align="center">
	...
	<tr>
		...
		<td class="row2"><textarea name="banner_name" rows="2" cols="35" wrap="virtual" style="width:450px" class="post">{BANNER_NAME}</textarea></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="row2"><input type="text" name="banner_url" size="50" maxlength="80" value="{BANNER_URL}" /></td>
	</tr>
	<tr>
