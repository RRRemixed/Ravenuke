...
<input type="hidden" name="action" value="update" />
  <table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	...
	<tr>
	  ...
	  <td class="row2"><input type="text" name="drawperiod" value="{V_L_LENGTH}" size="10" maxlength="15" class="post" /> Seconds</td>
	</tr>
	<tr>
...
<!-- END switch_enabled_items -->
  <table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	<tr>
		<td width="100%" align="center" class="row2"><br><span class="gensmall">Lottery Modification: Copyright © 2004, <a href="http://www.zarath.com/mods/" class="navsmall">Zarath Technologies</a>.<br>Ported For PHPNuke by <a href="http://codezwiz.com/">Telli</a>.</span><br><br></td>
	</tr>
  </table>
<br	clear="all" />
