...
{
	define('SHOP_ITEM_TABLE', 'nuke_shopitems');
}
...
if ($timeleft < 1)
{
	...
	header("Location: modules.php?name=Forums&file=lottery");
	exit;
}
...
elseif ($action == 'options')
{
	...
	{
		header("Location: modules.php?nameForums&file=lottery");
	}
}
