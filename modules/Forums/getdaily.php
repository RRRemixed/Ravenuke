...
/***************************************************************************
############################################################## 
## MOD Title: Get Last 24h Posts
## MOD Version: 1.0.0 
## Author: Daz < webmaster@jpcar.net > (Goose) http://www.jpcar.net/forum/
## Description: Search for the last 24 hours Posts  
## 
## Installation Level: Easy 
## Installation Time:  1 Minute
## Files To Edit: overall_header.tpl
## Included Files: getdaily.php 
############################################################## 
...
############################################################## 
## Authors Notes: 
## My first MOD. I hope you'll like it!
## Because 'Get last messages' reset really fast, i think this
## MOD is really usefull...
############################################################## 
...
if ( $search_results != '' )
{
	...
	{
		$sql = "SELECT t.*, f.forum_id, f.forum_name, u.username, u.user_id, u.user_color_gc, u2.username as user2, u2.user_id as id2, p.post_username, p2.post_username AS post_username2, p2.post_time 
	...
	for($i = 0; $i < count($searchset); $i++)
	{
		...
		else
		{
			...
			$searchset[$i]['username'] = CheckUsernameColor($searchset[$i]['user_color_gc'], $searchset[$i]['username']);
			...
			$searchset[$i]['user2'] = CheckUsernameColor($searchset[$i]['user_color_gc'], $searchset[$i]['user2']);
