...
if ($updategal != "" && $usergalid != "") {
	...
	<br>
	<a href='modules.php?name=$module_name&op=userhome&galid=$usergalid'><u>[Click Here] To go back to gallery home.</u></a>
	<br>";
...
<form method='POST' name='post' action='modules.php?name=$module_name&op=galedit&galid=$usergalid'>
