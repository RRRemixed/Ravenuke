...
if ($ajinfo[0] == "NONYET") {
    echo "<tr><td><strong><center><hr>List of Last 8 Main Galleries<hr></center></strong></td></tr>";
    echo "<tr><td><strong><center><br>No main galleries.<br><br><hr></center></strong></td></tr>";
} else {
    echo "<tr><td colspan='4'><strong><center><hr>List of Last 8 Main Galleries || <a href='modules.php?name=$module_name&op=viewall&galllookup=main'><u>View All Main Galleries</u></a><hr></strong></center></td></tr>";
echo "<tr>";
...
echo "</table><center><strong>End Of Main Galleries List || <a href='modules.php?name=$module_name&op=viewall&galllookup=main'><u>View All Main Galleries</u></a></center></strong><hr>";
//end of main galleries
...
if ($ajinfo1[0] == "NONYET") {
    echo "<tr><td><strong><center><hr>List of Last 8 Member Galleries<hr></center></strong></td></tr>";
    echo "<tr><td><strong><center><br>No Member galleries.<br><br><hr></center></strong></td></tr>";
} else {
echo "<tr><td><strong><center><hr>List of Last 8 Member Galleries || <a href='modules.php?name=$module_name&op=viewall&galllookup=member'><u>View All Member Galleries</u></a><hr></center></strong></td></tr>";
$x1=0;
while ($ajinfo1[$x1] != "") {
echo "<tr>";
echo "<td>";
...
echo "</table><center><strong>End of Members Gallery || <a href='modules.php?name=$module_name&op=viewall&galllookup=member'><u>View All Member Galleries</u></a><hr></strong></center><br>";

//end of member galleries list
...
function getmain1()
{
    ...
    if (is_admin($admin)) {
    	    $sql = "SELECT * FROM " . $prefix . "_reflections_gallery WHERE parentid='0' AND galtype='main' ORDER BY rawtime DESC LIMIT 8";
    } else {
    $sql = "SELECT * FROM " . $prefix . "_reflections_gallery WHERE parentid='0' AND galtype='main' AND active='1' ORDER BY rawtime DESC LIMIT 8";
}
...
function getmem()
{
    ...
    if (is_admin($admin)) {
    	    $sql = "SELECT * FROM " . $prefix . "_reflections_gallery WHERE parentid='0' AND galtype='member' ORDER BY rawtime DESC LIMIT 8";
    } else {
    $sql = "SELECT * FROM " . $prefix . "_reflections_gallery WHERE parentid='0' AND galtype='member' AND active='1' ORDER BY rawtime DESC LIMIT 8";
}
