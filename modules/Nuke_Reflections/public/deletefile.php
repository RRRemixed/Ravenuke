...
while ($i < $num) {
    ...
    if (is_admin($admin)) {
        ...
        if (strtolower($cookie[1]) != strtolower($fileupnick)) {
            ...
            echo "<b><center>File Delete Error! You are not the owner of this file!</b></center>";
	...
	<a href='modules.php?name=$module_name&op=deletefile&fileid=$filepicid&deletenow=yes'><u>YES</u></a>
	...
	<a href='modules.php?name=$module_name&op=deletefile&fileid=$filepicid&deletenow=yes'><u>YES</u></a><br>
