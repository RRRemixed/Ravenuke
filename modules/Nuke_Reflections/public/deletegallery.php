...
";
    ...
    $dir = "modules/$module_name/files/memgallery/$usergalfolder/fullsize/";
    if (is_dir($dir)) {
        if ($dh = opendir($dir)) {
    ...
    $dir = "modules/$module_name/files/memgallery/$usergalfolder/thumbs/";
    ...
    if ($parentid != "0") {
        ...
        while ($i1 < $num1) {
            ...
            $dir = "modules/$module_name/files/memgallery/$subfolder/fullsize/";
            ...
            $dir = "modules/$module_name/files/memgallery/$subfolder/thumbs/";
...
$deletefileerror = "fileerror";
        ...
        $path1 = "modules/$module_name/files/memgallery/$foldertokill[$x]/fullsize";
        $path2 = "modules/$module_name/files/memgallery/$foldertokill[$x]/thumbs";
        $path3 = "modules/$module_name/files/memgallery/$foldertokill[$x]";
...
<br>
<a href='modules.php?name=$module_name&op=deletegallery&galid=$usergalid&confirm=yes'><u>[Yes]</u></a> || <a href='modules.php?name=$module_name&op=userhome&galid=$usergalid'><u>[No Go Back]</u></a><br>
";
}
