...
$deletenow = devilcleanitup($deletenow);
    ...
    echo "<a href='modules.php?name=$module_name&adminarea=adminuserhome&galid=$galid'><u>Go To Gallery</u></a><br><table border='2' width='100%'><tr><td colspan='2'>";
...
<a href='modules.php?name=$module_name&adminarea=adminfileedit&fileid=$filepicid&newthumb=create'><u><strong>
...
<form method='POST' action='modules.php?name=$module_name&adminarea=adminfileedit&fileid=$filepicid'>
...
<button name='B3' value='savenew' type='submit' onMouseover=\"ddrivetip('<b> <center>Save Changes </center></b>','white', 300)\"; onMouseout=\"hideddrivetip()\"><img src='modules/$module_name/images/save.gif'></button>
 ...
 || <a onclick=\"deviltag1();\" onMouseover=\"ddrivetip('<b> <center>Delete this file </center></b>','white', 300)\"; onMouseout=\"hideddrivetip()\"><img height='16' width='16' src='modules/$module_name/images/delete.gif'></a>
...
";
    ...
    echo "<form method='POST' action='modules.php?name=$module_name&adminarea=adminfileedit&fileid=$filepicid'>";
...
Total Views </td><td>:: $filetotalview || <a href='modules.php?name=$module_name&adminarea=adminfileedit&fileid=$filepicid&reset=totalview'><img src='modules/$module_name/images/reset.gif' height='10' width='10' border='0'><u>Reset</u><img src='modules/$module_name/images/reset.gif' height='10' width='10' border='0'></a></td>
...
File Rating :: $avaragescore || <a href='modules.php?name=$module_name&adminarea=adminfileedit&fileid=$filepicid&reset=rating'><img src='modules/$module_name/images/reset.gif' height='10' width='10' border='0'> <u><b>Reset Score</u></b> <img src='modules/$module_name/images/reset.gif' height='10' width='10' border='0'></a>
...
if (is_admin($admin)) {
		...
		echo " - Ip Address :: $byipaddy - <a href='modules.php?name=$module_name&adminarea=adminfileedit&fileid=$filepicid&deletecomid=$comid'>Delete Comment</a>";

	} else if ($allowmemberdelcomment == "1") {

		echo " - <a href='modules.php?name=$module_name&adminarea=adminfileedit&fileid=$filepicid&deletecomid=$comid'>Delete Comment</a>";
