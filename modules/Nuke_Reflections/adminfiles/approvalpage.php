...
echo "<tr>";
$tr = "0";
$sql = "SELECT * FROM " . $prefix . "_reflections_files WHERE approved='0' ORDER BY `rawtime` DESC";
...
if ($filetotalreports == "0") {
echo "Free of Reports <img src='modules/$module_name/images/okyes.gif'><br>";
} else {
echo "Free of Reports <img src='modules/$module_name/images/okno.gif'><br>";
}

echo "<a href=\"modules.php?name=$module_name&adminarea=adminapproveprocess&fileid=$filepicid&setstat=approve&goback=approval\">[Approve]</a>";
echo " || ";
echo "<a href=\"modules.php?name=$module_name&op=viewbig&picid=$filepicid\">[More Info]</a><br>";
echo "<br><a href=\"http://devil-modz.us/modules.php?name=$module_name&adminarea=admindeletefile&deletenow=yes&fileid=$filepicid&goback=approval\">[Delete]</a>";
