...
if ($db->sql_numrows($result) > 0) {
	echo '<center><p><b>' . _CLICK2LIST . '</b></p>'
	...
	while ($row = $db->sql_fetchrow($result)) {
		...
		echo '<table border="0" width="100%" align="center" cellpadding="2">'
			...
			. '<big><strong>&middot;</strong></big>&nbsp;<b>' . _TOTNEWS . ':</b> ' . $numrows . '&nbsp;'
			. '<big><strong>&middot;</strong></big>&nbsp;<b>' . _TOTREADS . ':</b> ' . $reads . '</p></center>'
			. '</td></tr>'
			. '</table>';
		echo '<table border="0" width="100%" align="center" cellpadding="2">'
			. '<tr><td valign="top" align="left">'
			. '<p><b>' . _TOPICS_ARTICLES . '</b></p><p>';
		...
		if ($num != 0) {
			...
			if ($num == 10) {
				echo '<big><strong>&middot;</strong></big>&nbsp;<a href="modules.php?name=News&amp;new_topic=' . $topicid . '"><b>' . _MORE . ' --&gt;</b></a>';
			}
		} else {
			echo '<i>' . _NONEWSYET . '</i>';
		}
		...
		if ($num >= 1) {
			...
			echo '<center><p><b>' . _TOPICS_MOSTRECENTART . '</b></p></center>';
			echo '<p><b><a href="modules.php?name=News&amp;file=article&amp;sid=' . $s_sid . '">' . $title . '</a></b><br />' . _TOPICS_BY . ' '
