...
if ($op == 'nfSaveConfig') 
{
  ...
  $xfeedcount_body = strip_tags(html_entity_decode($xfeedcount_body, ENT_QUOTES));
  $xfeedcount_text = strip_tags(html_entity_decode($xfeedcount_text, ENT_QUOTES));
  $xfeedburner_url = strip_tags(html_entity_decode($xfeedburner_url, ENT_QUOTES));
...
{
  $contentName  = strip_tags(html_entity_decode($contentName, ENT_QUOTES));
  $module_name  = strip_tags(html_entity_decode($module_name, ENT_QUOTES));
  if(!get_magic_quotes_gpc())
  {
