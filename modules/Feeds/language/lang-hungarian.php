...
# General
define('_FEEDS','Feedek/hírmodulok');
define('_FEEDS_ADMIN','Feed Adminisztráció');
define('_nF_FEEDLIST','Feed Lista');
define('_FEED_PREVIEW','Feed Elõnézet');
define('_nF_SUBSCRIBE','Feliatkozás');
define('_nF_NEWS', 'Hírek');
define('_nF_FORUMS', 'Fórumok');
define('_nF_ADDCONTENT', 'Válasszon típust');
define('_nF_CURVER', 'Legfrissebb verzió.');
define('_nF_NEWVER', '<strong>Újabb verzió elérhetõ!</strong>');
define('_nF_GETNEWVER', 'Letölthetõ verzió: ');
define('_nF_FEEDCIRCDATAFOR', 'Feed forgalmazási adatok a következõ helyhez:');
define('_nF_TOGGLECOLORSPHERE', 'Színválasztó');

# Admin Menu
define('_nukeFEED','nukeFEED');
define('_nF_CONFIG','Configuráció');
