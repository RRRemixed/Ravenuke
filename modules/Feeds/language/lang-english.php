...
# General
define('_FEEDS','Feeds');
define('_FEEDS_ADMIN','Feed Administration');
define('_nF_FEEDLIST','Feed List');
define('_FEED_PREVIEW','Feed Preview');
define('_nF_SUBSCRIBE','Subscribe');
define('_nF_NEWS', 'News');
define('_nF_FORUMS', 'Forums');
define('_nF_ADDCONTENT', 'Select type');
define('_nF_CURVER', 'You have the current version.');
define('_nF_NEWVER', '<strong>A newer version is available!</strong>');
define('_nF_GETNEWVER', 'Get version ');
