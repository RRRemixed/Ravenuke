...
# General
define('_FEEDS','Feeds');
define('_FEEDS_ADMIN','Administraci&oacute;n de Feeds');
define('_nF_FEEDLIST','Lista de Feeds');
define('_FEED_PREVIEW','Previsualizar Feed');
define('_nF_SUBSCRIBE','Suscribir');
define('_nF_NEWS', 'Noticias');
define('_nF_FORUMS', 'Foros');
define('_nF_ADDCONTENT', 'Seleccionar tipo');
define('_nF_CURVER', 'Tienes la versi&oacute;n actual.');
define('_nF_NEWVER', '<strong>Est&aacute; disponible una nueva versi&oacute;n!</strong>');
define('_nF_GETNEWVER', 'Obtener versi&oacute;n ');
define('_nF_FEEDCIRCDATAFOR', 'Datos de circulaci&oacute;n del Feed para');
define('_nF_TOGGLECOLORSPHERE', 'Activar selector de color');

# Admin Menu
define('_nukeFEED','nukeFEED');
define('_nF_CONFIG','Configuraci&oacute;n');
define('_nF_ADMIN','Feeds');
define('_nF_AGGREGATORS', 'Agregadores');
define('_nF_SITEADMIN','Administraci&oacute;n del Sitio');

# Configuration
define('_nF_FEEDBURNERSETTINGS', 'Configuraci&oacute;n de FeedBurner');
define('_nF_USE_FEEDBURNER', '&iquest;Usar FeedBurner?');
define('_nF_FEEDBURNER_URL', 'URL Base del Feen en FeedBurner');
define('_nF_SHOW_CIRCGRAPH', '&iquest;Mostrar gr&aacute;fico de circulaci&oacute;n del feed?');
define('_nF_SHOW_FEEDCOUNT', 'Show Feed Count Chicklet?');
define('_nF_FEEDCOUNT_COLORS', 'FeedCount Chicklet Colors');
define('_nF_DISABLEMOD', 'Desactivar M&oacute;duloes');
define('_nF_DISABLEDMODS', 'M&oacute;dulos Inactivos');
define('_nF_DISABLE', 'Desactivar');
define('_nF_ENABLE', 'Activar');

# Feeds
define('_nF_TITLE', 'T&iacute;tulo del Feed');
define('_nF_CONTENT', 'Contenido');
define('_nF_CONTENTNAME', 'Nombre del Contenido');
define('_nF_ORDER', 'Orden');
define('_nF_HOWMANY', '# de elemementos');
define('_nF_LEVEL', 'Nivel');
define('_nF_LID', 'ID del Nivel');
define('_nF_DESC', 'Descripci&oacute;n');
define('_nF_STATUS', 'Estado');
define('_nF_FEEDBURNER_FEED_ADDRESS','Direcci&oacute;n del Feed en FeedBurner');

define('_nF_ADD','Agregar Feed');
define('_nF_EDIT','Editar Feed');
define('_nF_DELETE','Eliminar Feed');
define('_nF_SAVE', 'Guardar');

# Aggregators
define('_nF_AGGREGATOR', 'Agregador');
define('_nF_URL', 'URl de la suscripción');
define('_nF_URLTEXT', 'Variables de la URL: ');
define('_nF_TAGLINE', 'Etiqueta de título / lema de la sucripción');
define('_nF_IMAGE', 'Imagen');
define('_nF_ICON', 'Icono');

define('_nF_ADDAGGREGATOR', 'Añadir Agregador');
define('_nF_EDITAGGREGATOR', 'Editar Agregador');
define('_nF_EDIT_SUB','Editar subscripción');
define('_nF_DELETE_SUB','Eliminar subscripción');

# Selection values
define('_nF_ACTIVE', 'Activo');
define('_nF_INACTIVE', 'Inactivo');
define('_nF_YES', 'Sí');
define('_nF_NO', 'No');

# Errors
define('_nF_LIDREQUIRED', 'Se requiere un ID de nivel');
define('_nF_TITLEREQUIRED', 'Se requiere un título');
define('_nF_CONTENTREQUIRED', 'Se requiere un tipo de contenido');
define('_nF_ORDERREQUIRED', 'El orden es requerido');
define('_nF_HOWMANYREQUIRED', 'Se requiere el número de elementos del feed');
define('_nF_LEVELREQUIRED', 'Se requiere el nivel');
define('_nF_NAMEREQUIRED', 'Se requiere un nombre para la suscripción');
define('_nF_TAGLINEREQUIRED', 'Se requiere un lema');
define('_nF_URLREQUIRED', 'Se requiwre una URL para la suscripción');

# Help - Menu
define('_nF_CONFIG_HLP', 'Configurar FeedBurner y desactivar modules para la creación de feeds.');
define('_nF_ADMIN_HLP', 'Crear, activar y desactivar sindicación de feeds.');
define('_nF_AGGREGATORS_HLP', 'Definir los vínculos de suscripción para los agregadores de feeds.');
define('_nF_SITEADMIN_HLP', 'Regresar al sistema de administración de PHP-Nuke.');
# Help - Configuration
