...
# General
define('_FEEDS','Feed');
define('_FEEDS_ADMIN','Amministrazione Feed');
define('_nF_FEEDLIST','Lista Feed');
define('_FEED_PREVIEW','Anteprima Feed');
define('_nF_SUBSCRIBE','Iscriviti');
define('_nF_NEWS', 'Notizie');
define('_nF_FORUMS', 'Forum');
define('_nF_ADDCONTENT', 'Seleziona tipologia');
define('_nF_CURVER', 'Sei aggiornato all\'ultima versione.');
define('_nF_NEWVER', '<strong>E\' disponibile una nuova versione!</strong>');
define('_nF_GETNEWVER', 'Recupera versione ');
...
define('_nF_SITEADMIN','Amministrazione sito');
