...
define('_PAGINATOR_TOTALSTORIES','total stories');
...
define('_SOMETHINGSNOTRIGHT','Something is not right. This message is just to keep things from messing up down the road');
...
if (!defined('_YOUCANREAD')) define('_YOUCANREAD','Vous pouvez lire d\'autres articles intéressant sur');
