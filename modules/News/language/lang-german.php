...
define('_ANNOYINGMSG','Nach meinen Aufzeichnungen existiert das Thema nicht, auf das Sie versuchen zu antworten. Wenn Sie nur st&ouml;ren wollen, Pech gehabt.');
...
define('_HASSENTERROR','Artikel wurde aufgrund eines Mailer Fehlers nicht gesendet. Bitte kontaktieren Sie den Seitenadministrator.');
...
if (!defined('_NEWEST')) define('_NEWEST','Neue zuerst');
define('_NEWSBY','Nachrichten von');
define('_NEWUSER','neuer Benutzer');
define('_NICETRY','Netter Versuch..');
...
define('_NOCOMMENTSACT','Es ist leider kein Kommentar f&uuml;r diesen Artikel vorhanden.');
...
define('_PAGINATOR_TOTALSTORIES','Artikel insgesamt');
...
define('_SOMETHINGSNOTRIGHT','Irgendetwas ist mit der Verarbeitung dieser Variablen nicht korrekt. This message is just to keep things from messing up down the road');
define('_SUBJECT','Betreff');
define('_THANKS','Danke!');
define('_THANKSVOTEARTICLE','Danke f&uuml;r Ihre Bewertung!');
define('_THEURL','Die URL f&uuml;r diesen Artikel ist:');
if (!defined('_THREAD')) define('_THREAD','Diskussionsfaden');
define('_THRESHOLD','Grenze');
define('_TOAFRIEND','an Ihren Freund mit dem Namen:');
define('_UCOMMENT','Kommentar');
define('_URL','URL');
define('_USERINFO','Userinfo');
define('_VERYGOOD','Sehr gut');
if (!defined('_YOUCANREAD')) define('_YOUCANREAD','Hier können Sie weitere interessante Artikel lesen:');
define('_YOURFRIEND','Ihr Freund');
define('_YOURNAME','Dein Name');
define('_YOUSENDSTORY','Sie versenden diesen Artikel');
