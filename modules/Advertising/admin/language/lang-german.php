...
define('_ADDPLANERROR','<b>Error:</b> Ein oder mehrere Felder sind leer. Bitte geh zur&uuml;ck und korregiere das Problem.');
define('_ADDPOSITION','Position hinzuf&uuml;gen');
define('_ADFLASH','Flash');
define('_ADIMAGE','Bild');
define('_ADINFOINCOMPLETE','<b>Error:</b> Banner Informationen sind unvollst&auml;ndig!');
define('_ADPOSITIONS','Position der Werbung');
define('_ADSMODULEINACTIVE','[ Warnung: Das Werbungs-Modul ist inaktiv! ]');
define('_ADSNOCLIENT','<b>Error:</b> Es gibt keinen Werbe-Kunden.<br />Bitte erstelle einen neuen Kunden bevor du einen Banner hinzuf&uuml;gst.');
...
define('_CANTDELETEPOSITION','<b>Error:</b> Du kannst nicht alle Positionen l&oumL,schen. Zumindest sollte es in der Datenbank vorhanden sein.<br />Bearbeite die Positionen, &auml;ndere sie oder f&uuml;ge eine neue hinzu.');
...
define('_POSEXAMPLE','Wirf einen Blick in die Datei <i>/blocks/block-Advertising.php</i> und <i>/header.php</i> wo du ein Beispiel siehst wie du es auf deine Seite implementieren kannst.');
define('_POSINFOINCOMPLETE','<b>Error:</b> Werbe Positions Namensfeld darf nicht leer sein.');
...
define('_POSITIONNOTE','Um die Position zu verwenden musst du den Code: <i> ads(position);</i> in deine Theme Datei einf&uuml;gen, dabei ist "position" die Anzahl der gew&uuml;nschten Position die du in der Werbefl&auml;che nutzen m&ouml;chtest.');
