...
define('_ADDPLANERROR','<b>Error:</b> uno o m&aacute;s campos est&aacute;n vac&iacute;os. Por favor, vuelva atr&aacute;s y corrija el problema.');
define('_ADDPOSITION','Agregar Posici&oacute;n');
define('_ADFLASH','Flash');
define('_ADIMAGE','Im&aacute;gen');
define('_ADINFOINCOMPLETE','<b>Error:</b> La informacion del banner est&aacute; incompleta!');
...
define('_ADSNOCLIENT','<b>Error:</b> No hay ning&uacute;n cliente de publicidad.<br />Por favor crea un nuevo cliente antes de agregar un banner.');
...
define('_CANTDELETEPOSITION','<b>Error:</b> No puedes eliminar TODAS las posiciones. Al menos una debe existir en la base de datos.<br />Edita la posici&oacute;n si necesitas cambiarla o agrega una nueva');
define('_CLASS','Clase');
...
define('_POSEXAMPLE','Puedes echar un vistazo al archivo <i>/blocks/block-Advertising.php</i> y al archivo <i>/header.php</i> para tener un claro ejemplo de como implementar esto en el sitio.');
define('_POSINFOINCOMPLETE','<b>Error:</b> El campo Nombde de la Posici&oacute;n de Publicidad no puede estar en blanco.');
...
define('_POSITIONNOTE','Pra usar esta posici&oacute;n debes incluir el c&oacute;digo: <i> ads(position);</i> en el archivo del tema, donde \'position\' es el n&uacute;mero de la posici&oacute;n deseada.');
