...
define('_ACTIVEADSFOR','Bannières Active actuel pour');
define('_ADISNTYOURS','<b>Erreur:</b> La bannière que vous tentez d\'afficher n\'est pas affecté à votre compte.');
define('_ADSMENU','Publicité Menu');
define('_ADSNOCONTENT','Désolé pour le moment nous n\'avons pas de plans de publicité disponibles.');
define('_ADSYSTEM','Publicité System');
define('_ADVERTISING','Publicité');
define('_BANNERID','Bannière ID');
define('_BANNERIMAGE','Bannière Image');
define('_BANNERNAME','Bannière Name');
define('_BANNERURL','Bannière URL');
define('_BUYLINKS','Acheter Liens');
define('_CLICKS','Clicks');
define('_CLICKSPERCENT','Clicks pourcentage');
define('_CLIENTLOGIN','Login Client');
define('_CLIENTNAME','Nom du client');
define('_CURREGUSERS','Les utilisateurs actuels enregistré:');
define('_CURRENTSTATUS','Statut actuel:');
define('_DAYS','Jours');
define('_DESCRIPTION','Déscription');
...
define('_STATSSENTERROR','Statistics for your Ad Banner could not be sent due to a mailer issue<br />Please contact the Administrator');
if (!defined('_TERMS')) define('_TERMS','Terms');
