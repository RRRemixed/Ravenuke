...
include("footer.php");
    ...
    echo "<br>";
    OpenTable();
    echo "<br><center><b>Opps, you forgot to upload the Copyright.php file!<br><br>Upload the copyright.php file, and this message will go away.<br><br>Thanks for giving me credit!</b></center><br>";
    CloseTable();
    include("footer.php");
    die();
    }
...
include("header.php");
    if (file_exists("modules/$module_name/copyright.php")) {
include("modules/$module_name/js/DisModule.js");
       OpenTable();
echo "<center><img src=\"modules/PHP-Nuke_Tools/images/tools.gif\"><br>";
    CloseTable();
    OpenTable();
...
include("header.php");
    if (file_exists("modules/$module_name/copyright.php")) {
include("modules/$module_name/js/DisBlock.js");
    OpenTable();
echo "<center><img src=\"modules/PHP-Nuke_Tools/images/tools.gif\"><br>";
    CloseTable();
    OpenTable();
...
include("header.php");
    if (file_exists("modules/$module_name/copyright.php")) {
include("modules/$module_name/js/DisHTMLPHP.js");
        OpenTable();
echo "<center><img src=\"modules/PHP-Nuke_Tools/images/tools.gif\"><br>";
    CloseTable();
    OpenTable();
...
include("header.php");
    if (file_exists("modules/$module_name/copyright.php")) {
include("modules/$module_name/js/DisHTMLJS.js");
        OpenTable();
echo "<center><img src=\"modules/PHP-Nuke_Tools/images/tools.gif\"><br>";
    CloseTable();
    OpenTable();
...
include("header.php");
    if (file_exists("modules/$module_name/copyright.php")) {
include("modules/$module_name/js/DisHTMLASP.js");
        OpenTable();
echo "<center><img src=\"modules/PHP-Nuke_Tools/images/tools.gif\"><br>";
    CloseTable();
    OpenTable();
...
include("header.php");
    if (file_exists("modules/$module_name/copyright.php")) {
include("modules/$module_name/js/DisHTMLJSP.js");
    OpenTable();
echo "<center><img src=\"modules/PHP-Nuke_Tools/images/tools.gif\"><br>";
    CloseTable();
    OpenTable();
...
include("header.php");
    if (file_exists("modules/$module_name/copyright.php")) {
include("modules/$module_name/js/DisHTMLPERL.js");
        OpenTable();
echo "<center><img src=\"modules/PHP-Nuke_Tools/images/tools.gif\"><br>";
    CloseTable();
    OpenTable();
...
include("header.php");
    if (file_exists("modules/$module_name/copyright.php")) {
include("modules/$module_name/js/Dis.js");
    OpenTable();
echo "<center><img src=\"modules/PHP-Nuke_Tools/images/tools.gif\"><br>";
    CloseTable();
    OpenTable();
...
include("header.php");
    if (file_exists("modules/$module_name/copyright.php")) {
include("modules/$module_name/js/popup.js");
    OpenTable();
echo "<center><img src=\"modules/PHP-Nuke_Tools/images/tools.gif\"><br>";
    CloseTable();
    OpenTable();
...
include("header.php");
    if (file_exists("modules/$module_name/copyright.php")) {
include("modules/$module_name/js/DisMTags.js");
    OpenTable();
echo "<center><img src=\"modules/PHP-Nuke_Tools/images/tools.gif\"><br>";
    CloseTable();
    OpenTable();
...
include("header.php");
    if (file_exists("modules/$module_name/copyright.php")) {
include("modules/$module_name/js/HTMLSWS.js");
        OpenTable();
echo "<center><img src=\"modules/PHP-Nuke_Tools/images/tools.gif\"><br>";
    CloseTable();
    OpenTable();
...
include("header.php");
    if (file_exists("modules/$module_name/copyright.php")) {
include("modules/$module_name/js/emailencoder.js");
       OpenTable();
echo "<center><img src=\"modules/PHP-Nuke_Tools/images/tools.gif\"><br>";
    CloseTable();
    OpenTable();
echo " <TABLE  cellSpacing=0 cellPadding=0 width=\"100%\" border=0>"
  ...
  . "<B>enter your e-mail address</B> in the first text box, <B>click the "
  . "encode</B> button, and then <B>highlight and copy the resulting code</B> "
...
include("header.php");
    if (file_exists("modules/$module_name/copyright.php")) {
include("modules/$module_name/js/rot.js");
       OpenTable();
echo "<center><img src=\"modules/PHP-Nuke_Tools/images/tools.gif\"><br>";
    CloseTable();
    OpenTable();
...
include("header.php");
    if (file_exists("modules/$module_name/copyright.php")) {
include("modules/$module_name/js/URLCODER.js");
       OpenTable();
echo "<center><img src=\"modules/PHP-Nuke_Tools/images/tools.gif\"><br>";
    CloseTable();
    OpenTable();
...
include("header.php");
    if (file_exists("modules/$module_name/copyright.php")) {
include("modules/$module_name/js/PREVIEWER.js");
       OpenTable();
echo "<center><img src=\"modules/PHP-Nuke_Tools/images/tools.gif\"><br>";
    CloseTable();
    OpenTable();
...
include("header.php");
    if (file_exists("modules/$module_name/copyright.php")) {
include("modules/$module_name/js/HTMLENCODER.js");
        OpenTable();
echo "<center><img src=\"modules/PHP-Nuke_Tools/images/tools.gif\"><br>";
    CloseTable();
    OpenTable();
...
include("header.php");
    ...
    if (file_exists("modules/$module_name/copyright.php")) {
include("modules/$module_name/js/SourceCoder.js");      
OpenTable();
echo "<center><img src=\"modules/PHP-Nuke_Tools/images/tools.gif\"><br>";
    CloseTable();
    OpenTable();
