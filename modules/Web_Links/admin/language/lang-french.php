...
/**************************************************************************/
if (!defined('_ADDNEWLINK')) { define('_ADDNEWLINK','Ajouter un nouveau Lien'); }
if (!defined('_ADDURL')) {define('_ADDURL','Ajouter cet URL');}
...
if (!defined('_DESCRIPTION255')) {define('_DESCRIPTION255','Description: (255 caract&egrave;res max)');}
if (!defined('_EDITORIALTEXT')) { define('_EDITORIALTEXT','Edito');}
if (!defined('_EDITORIALTITLE')) { define('_EDITORIALTITLE','Titre de l\'&eacute;ditorial');}
define('_EZBROKENLINKS','Liens morts');
if (!defined('_EZTRANSFERLINKS')) { define('_EZTRANSFERLINKS','Transférer tous les liens de la catégorie');}
define('_IGNOREINFO','Ignorer (Efface toutes <b><i>les requ&ecirc;tes</i></b> pour un lien donn&eacute;)');
if (!defined('_IN')) {define('_IN','Dans');}
define('_LINK','Lien');
...
if (!defined('_PAGETITLE')) {define('_PAGETITLE','Titre de la page');}
if (!defined('_PAGEURL')) {define('_PAGEURL','URL de la page');}
define('_TEAM','Equipe.');
