...
/**************************************************************************/
if (!defined('_ADDNEWLINK')) { define('_ADDNEWLINK','Neuen Link einf&uuml;gen'); }
if (!defined('_ADDURL')) {define('_ADDURL','URL einf&uuml;gen');}
...
if (!defined('_DESCRIPTION255')) { define('_DESCRIPTION255', 'Beschreibung: (maximal 255 Zeichen)');}
if (!defined('_EDITORIALTEXT')) { define('_EDITORIALTEXT','Text');}
if (!defined('_EDITORIALTITLE')) { define('_EDITORIALTITLE','Titel');}
define('_EZBROKENLINKS','Tote Links');
if (!defined('_EZTRANSFERLINKS')) define('_EZTRANSFERLINKS','&Uuml;bertrage alle Links von dieser Kategorie');
...
if (!defined('_PAGETITLE')) {define('_PAGETITLE','Seitentitel');}
if (!defined('_PAGEURL')) {define('_PAGEURL','Seitenadresse-URL');}
