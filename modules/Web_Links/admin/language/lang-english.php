...
if (!defined('_TEAM')) { define('_TEAM','Team.'); }
if(!defined('_THANKS4YOURSUBMISSION')) { define('_THANKS4YOURSUBMISSION','Thanks for your submission!'); }
...
if(!defined('_YOUCANBROWSEUS')) {define('_YOUCANBROWSEUS','You can browse or search our web links at:'); }
