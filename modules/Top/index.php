...
if ($db->sql_numrows($result) > 0) {
    echo '<table border="0" cellpadding="10" width="100%"><tr><td align="left">'
        .'<font class="option"><b>'.$top.' '._READSTORIES.'</b></font><br /><br />';
    $lugar=1;
...
if ($db->sql_numrows($result2) > 0) {
    echo '<table border="0" cellpadding="10" width="100%"><tr><td align="left">'
        .'<font class="option"><b>'.$top.' '._MOSTVOTEDSTORIES.'</b></font><br /><br />';
    $lugar=1;
...
if ($db->sql_numrows($result3) > 0) {
    echo '<table border="0" cellpadding="10" width="100%"><tr><td align="left">'
        .'<font class="option"><b>'.$top.' '._BESTRATEDSTORIES.'</b></font><br /><br />';
    $lugar=1;
...
if ($articlecomm == 1) {
    ...
    if ($db->sql_numrows($result4) > 0) {
        echo '<table border="0" cellpadding="10" width="100%"><tr><td align="left">'
            .'<font class="option"><b>'.$top.' '._COMMENTEDSTORIES.'</b></font><br /><br />';
        $lugar=1;
...
if ($db->sql_numrows($result5) > 0) {
    echo '<table border="0" cellpadding="10" width="100%"><tr><td align="left">'
        .'<font class="option"><b>'.$top.' '._ACTIVECAT.'</b></font><br /><br />';
    $lugar=1;
...
if ($db->sql_numrows($result7) > 0) {
    echo '<table border="0" cellpadding="10" width="100%"><tr><td align="left">'
        .'<font class="option"><b>'.$top.' '._NEWSSUBMITTERS.'</b></font><br /><br />';
    $lugar=1;
...
if ($db->sql_numrows($result8)>0) {
    echo '<table border="0" cellpadding="10" width="100%"><tr><td align="left">'
        .'<font class="option"><b>'.$top.' '._VOTEDPOLLS.'</b></font><br /><br />';
    $lugar = 1;
...
if ($db->sql_numrows($result11) > 0) {
    echo '<table border="0" cellpadding="10" width="100%"><tr><td align="left">'
        .'<font class="option"><b>'.$top.' '._MOSTACTIVEAUTHORS.'</b></font><br /><br />';
    $lugar=1;
...
if ($db->sql_numrows($result12) > 0) {
    echo '<table border="0" cellpadding="10" width="100%"><tr><td align="left">'
        .'<font class="option"><b>'.$top.' '._READREVIEWS.'</b></font><br /><br />';
    $lugar=1;
...
if ($db->sql_numrows($result13) > 0) {
    ...
    while ($row13 = $db->sql_fetchrow($result13)) {
        ...
        if($hits>0) {
            ...
            echo '<strong><big>&middot;</big></strong>&nbsp;'.$lugar.': <a href="modules.php?name=Downloads&amp;d_op=viewdownloaddetails&amp;lid='.$lid.'">'.$title.'</a> ('._CATEGORY.': '.$ctitle.') - ('.$hits.' '._LDOWNLOADS.')<br />';
            $lugar++;
        }
    }
    echo '</td></tr></table>';
...
if ($db->sql_numrows($result14) > 0) {
    echo '<table border="0" cellpadding="10" width="100%"><tr><td align="left">'
        .'<font class="option"><b>'.$top.' '._MOSTREADPAGES.'</b></font><br /><br />';
    $lugar=1;
