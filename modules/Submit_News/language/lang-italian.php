...
define('_SUBPREVIEW','Esegui anteprima prima di mandare l\'articolo');
define('_SELECTTOPIC','Seleziona argomento');
define('_NEWSUBPREVIEW','Anteprima inserzione articolo');
define('_STORYLOOK','Il tuo Articolo sar&agrave; cos&igrave; come vedi questo:');
define('_CHECKSTORY','Controlla testo, links, etc. prima di inviare il tuo articolo!');
...
if (!defined('_USCORE')) define('_USCORE','Voto');
...
define('_SELECTMONTH2VIEW','Per favore, seleziona il mese da vedere:');
...
define('_NEXTPAGE','Pagina successiva');
