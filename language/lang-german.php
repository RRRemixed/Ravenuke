...
/* =======================================================================*/
/* This file translation is provided by Susann, a member of the RavenNuke */
/* Team - 2/24/2008                                                       */
...
define('_MODULESSUBSCRIBER','Es tut und leid, aber dieser Bereich unserer Seite ist nur f&uuml;r <i>Subscribed Users.</i>');
...
define('_SUBHERE','Sie k&ouml;nnen unseren Service abonnieren von <a href="'.$subscription_url.'">hier</a>');
...
define('_ALT_CHKPROFILE','Profil ansehen von '.$lastusername);
define('_ALT_SEND','Senden Sie direkt eine private Nachricht an ');
define('_BHITS','Hits');
define('_GUESTIPS_OPTION','- Guest IP\'s -');
define('_HIDDEN','Versteckt');
define('_HIDDEN_ABBREV','(H)');
define('_PASSWORDLOST','Passwort verloren');
define('_SERDT','Server Datum/Zeit');
define('_TTL_RESENDEMAIL','Resend Email phpNuke Module at RavenPHPScripts');
define('_WAITLINK','Wartend');
define('_YOURIP','Ihre IP: ');
