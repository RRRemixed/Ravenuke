...
define('_AB_CLEAREXCLUDEDS','Alle ausgenommenen IP-Bereiche l&ouml;schen.<br /><b>WARNUNG:</b> L&ouml;scht alle ausgenommenen Bereiche aus der Datenbank.<br />');
define('_AB_CLEAREXPIRED','Verfallene Sperren l&ouml;schen');
define('_AB_CLEARIP','Alle IP-Adressen l&ouml;schen');
define('_AB_CLEARIPS','L&ouml;sche alle IP-Adressen.<br /><b>WARNUNG:</b> Dies leert die Tabelle der gesperrten IPs.<br /><b>HINWEIS:</b> Dies beeinflu&szlig;t nicht Ihre .htaccess-Datei, falls verwendet.');
define('_AB_CLEARPROTECTED','Alle priviligierten IP-Bereiche l&ouml;schen');
define('_AB_CLEARPROTECTEDS','Alle priviligierten IP-Bereiche l&ouml;schen.<br /><b>WARNUNG:</b> L&ouml;scht alle priviligierten Bereiche aus der Datenbank.<br />');
...
define('_AB_CLEARRANGES','Alle gesperrten IP-Bereiche l&ouml;schen.<br /><b>WARNUNG:</b> L&ouml;scht alle gesperrten Bereiche aus der Datenbank.');
define('_AB_CLEARTRACKED','Alle &uuml;berwachten IPs l&ouml;schen');
define('_AB_CLEARTRACKEDS','Alle &uuml;berwachten IPs l&ouml;schen.<br /><b>WARNUNG:</b> L&ouml;scht alle &uuml;berwachten IPs aus der Datenbank.<br />');
...
define('_AB_EDITIPS','Editiere eine IP-Adresse oder ein Subnet.<br />Um ein Subnet zu editieren, benutze die Syntax: <i>192.168.1.*</i>');
...
define('_AB_FLOODERS','<b>Intentional</b> Flood Attacken:');
...
define('_AB_HIERROR','Die IP ZU <b>MUSS</b> zwischen 0 and 255 nummeriert werden!');
define('_AB_HILOERROR','Die IP ZU <b>MUSS</b> numerisch gr&ouml;sser sein als die IP VON!');
...
define('_AB_IP2CUPDATE04C','<b>Anmerkung:</b> Diese Operation wird ihre Seite automatisch deaktivieren und wieder aktivieren wenn der Vorgang abgeschlossen ist.');
...
define('_AB_IPERROR','Die IP <b>MUSS</b> ein Oktette zwischen 0 und 255 sein!');
...
define('_AB_LOERROR','Die IP von <b>MUSS</b> ein Oktette zwischen 0 und 255 sein!');
...
define('_AB_HELP_004',"W&auml;hlen Sie das Template das angezeigt werden soll, wenn obiger Schalter auf <b>Deaktiviert</b> steht.");
define('_AB_HELP_005',"Wenn verf&uuml;gbar, k&ouml;nnen Sie bereits auf Serverebene sperren. Geben Sie den Pfad zu Ihrer .htaccess-Datei hier ein.<br />Generally this is <b>.htaccess</b> .");
define('_AB_HELP_006',"Liste der IP-Adressen, an die Berichte versendet werden sollen.<br /><b>Jeweils nur ene Adresse pro Zeile eingeben.</b>");
define('_AB_HELP_007',"Wenn verf&uuml;gbar, k&ouml;nnen Sie die HTTPAuth-Anmeldung f&uuml;r die Zugangskontrolle zu Ihren admin.php-Seiten aktivieren, indem Sie diese Option auf <b>An</b> setzen.");
define('_AB_HELP_008',"Die Anzahl der anzuzeigenden IPs pro Seite in der Ansicht <b>Gesperrte IP-Adressen</b>.");
define('_AB_HELP_009',"Das Standard-Sortierkriterium f&uuml;r die Ansicht <b>Gesperrte IP-Adressen</b>.");
define('_AB_HELP_010',"Die Standard-Sortierrichtung f&uuml;r die Ansicht <b>Gesperrte IP-Adressen</b>.");
define('_AB_HELP_011',"Um diesen Sperrtyp zu <b>Aktivieren</b>, w&auml;hlen Sie eine der Optionen in der Liste.<br /><br /><b>Umleiten</b> = leitet missbr&auml;chliche Nutzer an eine URL weiter.<br /><br /><b>Standardseite zeigen</b> = leitet missbr&auml;chliche Nutzer an eine gew&auml;hlte Seitenvorlage weiter.");
define('_AB_HELP_012',"Wenn verf&uuml;gbar und gew&auml;hlt, kann dieser Sperrtyp IPs in Ihre .htaccess-Datei eintragen.");
define('_AB_HELP_013',"Dies ist eine volle URL, an die Nutzer weitergeleitet werden sollen, wenn Sie diesen Sperrtyp ausl&ouml;sen.<br /><b>Aktivierung mu&szlig; mit einer \'Umleiten\'-Option eingestellt sein.</b>");
define('_AB_HELP_014',"Wie soll die IP in die Datenbank gespeichert werden. Um eine einzelne IP zu sperren, nutzen Sie <b>Volle IP</b>, um ein komplettes Oktett zu sperren, nutzen Sie <b>1 Oktett</b>, f&uuml;r zwei komplette Oktette <b>2 Oktette</b>, f&uuml;r drei komplette Oktette <b>3 Oktette</b>");
...
define('_AB_HELP_016',"Wenn verf&uuml;gbar, k&ouml;nnen abgerufene Details der IP-Adresse in die Email an den Administrator aufgenommen werden, indem Sie diese Option auf <b>An</b> setzen.");
define('_AB_HELP_017',"Dieser Text wird in die Benachrichtigungsmail an Administratoren aufgenommen, stellen Sie sicher das er f&uuml;r alle verst&auml;ndlich ist. <b>Mi&szlig;brauch-</b> wird entfernt, wenn Sie die Ansicht <b>Gesperrte IP-Adressen</b> nutzen.");
define('_AB_HELP_018',"Sie k&ouml;nnen diesen Sperrtyp auf <b>Permanent</b> oder auf Verfall nach einer gew&auml;hlten Anzahl Tagen setzen. Das Datum in der Liste zeigt den Verfall der Sperre, w&ouml;rde die Sperre jetzt gerade eintreten.");
...
define('_AB_HELP_020',"Geben Sie einen Domain-String pro Zeile ein.<br />Die Strings werden mit dem HTTP Refer(r)er verglichen und sollten dem Format <b>Domainname.tld</b> oder <b>Sub.Domainname.tld</b> entsprechen.");
define('_AB_HELP_021',"Geben Sie einen String pro Zeile ein.<br />Hier k&ouml;nnen Sie jede beliebige <b>Request Method</b> sperren.<br /><br /><b>WARNUNG!!!!!</b> Eingabe von GET oder POST schickt Ihre Seite in eine Endlos-Schleife!");
define('_AB_HELP_022',"Geben Sie einen String pro Zeile ein.<br />Hier k&ouml;nnen Sie jeden beliebigen <b>String</b> sperren.<br />Die Strings werden mit dem <b>Query String</b> verglichen, Sie sollten hier Vorsicht walten lassen.");
...
define('_AB_HELP_027',"F&uuml;gen sie eine IP zur Liste <b>Gesperrte IPs</b> hinzu.");
...
define('_AB_HELP_030',"Erlaubt Dir eine Suche nach <b>geblockten IP Addressen</b> oder <b>überwachten IP Addressen</b> einer spezifische IP Addresse.");
define('_AB_HELP_031',"<b>NUR F&Uuml;R GOD ADMINS:</b> Wenn verf&uuml;gbar k&ouml;nnen Administratoren HTTPAuth Logins gestattet werden.");
define('_AB_HELP_032',"<b>NUR F&Uuml;R GOD ADMINS:</b> Pr&uuml;ft neue Administratoren in der _authors-Tabelle gegen obige Listen. L&ouml;scht Administratoren, die nicht mehr in der _authors-Tabelle stehen aus den Listen.");
...
define('_AB_HELP_040',"Erlaubt den Schutz Ihrer Seite vor bestimmten Request Methods, wie HEAD und SEARCH.<br /><br /><b>WARNUNG!</b> Nicht verwenden, um POST oder GET zu sperren, dies kann Ihre Seite in eine Endlosschleife schicken.");
...
define('_AB_HELP_042',"Aktiviere automatische L&ouml;schung <b>verfallener</b> Sperren.<br /><br />Nutzen Sie diese Funktion mit <b>VORSICHT</b>, da sie die Ladezeit der Seite verl&auml;ngern kann!");
...
define('_AB_HELP_045',"W&auml;hlen sie die Seitenvorlage, die gezeigt werden soll wenn obiger Schalter auf <b>An</b> steht.");
define('_AB_HELP_046',"Aktiviere <b>D</b>enial <b>O</b>f <b>S</b>ervice Attacken Sperrung.<br /><br />Beachte das diese Funktion nur vor DOS Atacken, nicht aber DDOS Attacken sch&uuml;tzt. Arbeitet nicht 100%ig, stoppt jedoch die meisten Attacken.");
define('_AB_HELP_047',"Zwinge Benutzer auf die <b>".$nuke_config['nukeurl']."</b>-URL. Diese ist in der ".$prefix."_config-Tabelle gespeichert und kann &uuml;ber Administration -> Einstellungen ge&auml;ndert werden.<br /><br />Dies ist praktisch wenn Ihre Seite unter http://Ihreseite.tld und http://www.Ihreseite.tld erreichbar ist.");
...
define('_AB_HELP_050',"Um die IP-&Uuml;berwachung zu <b>aktivieren</b> w&auml;hle <b>An</b>.<br /><br />Zum <b>Deaktivieren</b> w&auml;hle <b>Aus</b>.");
define('_AB_HELP_051',"Maximale Anzahl Zeilen f&uuml;r &uuml;berwachte IPs in der Datenbank.");
define('_AB_HELP_052',"Anzahl der zu entfernenden Datenbank-Zeilennummer bei Erreichen des Maximums.<br /><br />Wenn <b>gr&ouml;sser</b> oder <b>gleich</b> der \'Maximale Zeilen\'-Einstellung oben, maximum above, entfernt das Script jeweils nur ein Zehntel der Zeilen bei Erreichen des Maximums.");
define('_AB_HELP_053',"Anzahl der anzuzeigenden IPs pro Seite auf der <b>&Uuml;berwachte IPs</b> &Uuml;bersichtsseite.");
define('_AB_HELP_054',"Das Standard Sortierkriterium f&uuml;r die <b>&Uuml;berwachte IPs</b> &Uuml;bersichtsseiten.");
define('_AB_HELP_055',"Die Standard-Sortierrichtung f&uuml;r die <b>&Uuml;berwachte IPs</b> &Uuml;bersichtsseiten.");
...
define('_AB_HELP_058',"<b>Nur f&uuml;r GOD-Admins:</b> Erlaubt das Anzeigen, Optimieren und Reparieren Deiner Datenbank. Zeigt alle Datenbanktabellen, nicht nur die von NukeSentinel™.");
define('_AB_HELP_059',"<b>Nur f&uuml;r GOD-Admins:</b> Zeigt Deine komplette Datenbank mit Gesamt-Speicherverbrauch und -&Uuml;berhang.");
define('_AB_HELP_060',"<b>Nur f&uuml;r GOD-Admins:</b> Scannt und optimiert Tabellen mit &Uuml;berhang in Deiner Datenbank.");
define('_AB_HELP_061',"<b>Nur f&uuml;r GOD-Admins:</b> Scannt und repariert fehlerhafte Tabellen in Deiner Datenbank.");
...
define('_AB_HELP_067',"Wird verwendet um einzigartige CGI-Authorisierungs-Passw&ouml;rter zu erzeugen. Max. L&auml;nge betr&auml;gt 2 Zeichen und kann jedes Zeichen auf der Tastatur enthalten. Beachte das andere Funktionen von NukeSentinel(tm) bestimmte Zeichenkombinationen evtl. blocken, z.B. <b>/*</b> und <b>*/</b>.");
define('_AB_HELP_068',"Mit dieser Einstellung kannst Du die Hilfe und Info Fenster nur anzeigen wenn Du auf das <img src='images/nukesentinel/helpicon.png' border='0' height='12' width='12' alt='' title=''> &amp; <img src='images/nukesentinel/infoicon.png' border='0' height='12' width='12' alt='' title=''> Bild klickst oder wenn Du mit der Maus dar&uuml;ber f&auml;hrst.<br /><br />Standard Einstellung ist <b>Mouseover</b>.");
define('_AB_HELP_069',"Das Standard Sortierkriterium f&uuml;r die <b>Suche gesperrte IPs</b> Seiten.");
define('_AB_HELP_070',"Die Standard-Sortierrichtung f&uuml;r die <b>Suche gesperrte IPs</b> Seiten.");
define('_AB_HELP_071',"Anzahl der anzuzeigenden IPs pro Seite auf der <b>Suche &uuml;berwachte IPs</b> Seite.");
define('_AB_HELP_072',"Das Standard Sortierkriterium f&uuml;r die <b>Suche &uuml;berwachte IPs</b> Seiten.");
define('_AB_HELP_073','Zeigt eine Liste aller &uuml;berwachten Referers an die sich in Deiner Datenbank befinden.');
define('_AB_HELP_074',"Diese Option <b>Entfernt</b> den ausgew&auml;hlten Punkt von der Liste.");
...
define('_AB_HELP_082',"Gib eine komplette IP-Adresse ein. <b>KEINE</b> Platzhalter erlaubt!");
...
define('_AB_HELP_100',"F&uuml;ge einen IP-Bereich zur <b>Ausgenommene IP-Bereiche</b> Liste hinzu.");
...
define('_AB_HELP_104',"F&uuml;ge einen IP-Bereich zur <b>Privilegierte IP-Bereiche</b> Liste hinzu.");
