...
$content  = '<center><img src="images/nukesentinel/nukesentinel_small.png" height="19" width="150" alt="'._AB_WARNED.'" title="'._AB_WARNED.'" /><br />'._AB_HAVECAUGHT.' '.intval($total_ips).' '._AB_SHAMEFULHACKERS.'</center>'."\n";
