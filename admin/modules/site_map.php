...
global $prefix, $db, $sitename, $currentlang, $admin_file, $dbi;
$aid = substr("$aid", 0,25);
...
Opentable();
            echo"<center><b>"._SITEMAPADMIN."</b></center>";
Closetable();
...
Opentable();
            echo'
				<form action="'.$PHP_SELF.'" method="post">
					<center>
					<table border="0" id="table6" width="50%" height="30%">
						<tr>
			...
			echo'			</td>
	            ...
	            <table border="0" width="566" id="table14">
    		        <tr>
						<td width="188">&nbsp;</td>
						<td width="164">
							<p align="center"><input type="submit" value="'._OK.'" name="ok"></form></p>
							<p align="center">&nbsp;</td>
						<td width="200">&nbsp;</td>
	   				</tr>
            	</table></td>
