...
// End - Delete removed modules
   ...
   echo '<br />';
	...
	echo '<br /><center><font class="option">' . _MODULESADDONS . '</font><br /><br />'
		...
		.'<b>'._TITLE.'</b></td><td align="center" bgcolor="'.$bgcolor2.'"><b>'._CUSTOMTITLE.'</b></td><td align="center" bgcolor="'
		.$bgcolor2.'"><b>'._STATUS.'</b></td><td align="center" bgcolor="'.$bgcolor2.'"><b>'._VIEW
		.'</b></td><td align="center" bgcolor="'.$bgcolor2.'"><b>'._UGROUPS.'</b></td><td align="center" bgcolor="'
		.$bgcolor2.'"><b>'._FUNCTIONS.'</b></td></tr>';
...
function module_edit($mid) {
	...
	if ($title == $main_module) {
		...
		echo '<tr><td>' . _VIEWPRIV . '</td><td><select name="view">'
			...
			.'</select></td></tr>';
		echo '<tr><td valign="top"><b>'._WHATGROUPS.':</b></td><td><font class="tiny">'._WHATGRDESC.'</font><br /><select name="groups[]" multiple="multiple" size="5">';
