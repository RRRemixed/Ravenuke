...
function OpenMenu($adsection="") {
  ...
  $nsnstcopy .= "<strong>License:</strong> Copyright &#169; 2000-2009 NukeSentinel(tm) Team<br />";
  ...
  $nva = '';
  $nva = '<center><p>'.@file_get_contents('http://www.ravenphpscripts.com/versions/nsnst.txt').'</p></center>';
