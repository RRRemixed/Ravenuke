...
unset($nsnst_const);
if(stristr(htmlentities($_SERVER["PHP_SELF"]), "nukesentinel.php") OR stristr(htmlentities($_SERVER["SCRIPT_NAME"]), "nukesentinel.php")) {
...
@require_once(NSINCLUDE_PATH."config.php");
@require_once(NSINCLUDE_PATH."db/db.php");

// Load required configs
global $remote, $nsnst_const, $nuke_config, $ab_config, $admin_file;
