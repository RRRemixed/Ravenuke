...
global $admin, $admin_file, $prefix, $hos_config; 
$memtable = $hos_config['membertable']; 
  OpenTable(); 
  echo "<h1>$ptitle</h1>"; 
  echo "<table>\n"; 
  echo "<tr>\n"; 
  echo "<td><a href='".$admin_file.".php?op=HoSReason_List'>"._HoS_REASONLIST."</a><br>\n"; 
  echo "<a href='".$admin_file.".php?op=HoSReason_Add'>"._HoS_ADDREASON."</a></td>\n"; 
  echo "<td><a href='".$admin_file.".php?op=HoSReasonCat_List'>"._HoS_CATEGORYLIST."</a><br>\n"; 
  echo "<a href='".$admin_file.".php?op=HoSReasonCat_Add'>"._HoS_ADDCATEGORY."</a></td>\n"; 
  echo "<td><a href='".$admin_file.".php?op=HoSPunk_List'>"._HoS_PUNKLIST."</a><br>\n"; 
  echo "<a href='".$admin_file.".php?op=HoSPunk_Add'>"._HoS_ADDPUNK."</a></td>\n"; 
  if ($memtable == $prefix."_hos_members"){ 
    echo "<td><a href='".$admin_file.".php?op=HoSMember_List'>"._HoS_MEMBERLIST."</a><br>\n"; 
    echo "<a href='".$admin_file.".php?op=HoSMember_Add'>"._HoS_ADDMEMBER."</a></td>\n"; 
     } 
  echo "<td><a href='".$admin_file.".php?op=HoSConfigure'>"._HoS_CONFIG."</a><br>\n"; 
  echo "<a href='".$admin_file.".php?op=HoSHelp'>"._HoS_HELP."</a></td>\n"; 
  echo "</tr>\n"; 
  echo "<tr><td><br><a href='".$admin_file.".php'>"._HoS_SITEADMIN."</a></td></tr>\n"; 
  echo "</table>\n"; 
  CloseTable(); 
} 

function mainheader($mainindex, $ptitle, $pmessage) { 
  global $modulename, $admin, $admin_file, $hos_config, $loc; 
  ...
  echo "<center>["; 
  if (is_admin($admin)) { echo " <a href='".$admin_file.".php?op=HoSAdmin'>"._HoS_ADMIN."</a> |"; } 
