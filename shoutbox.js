...
if(SBiedom){
	SBtxt='<div style="position:relative;width:100%;height:'+SBheight+'px;overflow:hidden" onmouseover="SBspeed=0" onmouseout="SBspeed=1"><div id="SBiemarquee" style="position:absolute;left:0px;top:0px;width:100%;"></div></div>';
}else{
